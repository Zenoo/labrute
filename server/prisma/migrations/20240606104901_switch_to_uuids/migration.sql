  ...
  */
  ...
  ALTER TABLE "BruteStartingStats" ADD COLUMN "bruteId" uuid ;
  ...
  ALTER TABLE "DestinyChoice" ADD COLUMN "bruteId" uuid;
  ...
  ALTER TABLE "TournamentAchievement" ADD COLUMN "bruteId" uuid ;
  ...
  ALTER TABLE "TournamentXp" ADD COLUMN "bruteId" uuid ;
  ...
  ALTER TABLE "_BruteToTournament" ADD COLUMN "A" uuid  ;
  ALTER TABLE "_BruteToTournament" DROP COLUMN "B";
  ALTER TABLE "_BruteToTournament" ADD COLUMN "B" uuid ;
  ...
  ALTER TABLE "_Opponents" ADD COLUMN "A" uuid ;
  ALTER TABLE "_Opponents" DROP COLUMN "B";
  ALTER TABLE "_Opponents" ADD COLUMN "B" uuid ;
  ...
  UPDATE "TournamentXp" ta SET "bruteId" = b."id" FROM "Brute" b WHERE b."temp_id" = ta."temp_bruteId" ;
...
-- AlterTable
ALTER TABLE "TournamentAchievement" ALTER COLUMN "bruteId" SET NOT NULL;

-- AlterTable
ALTER TABLE "TournamentXp" ALTER COLUMN "bruteId" SET NOT NULL;

-- AlterTable
ALTER TABLE "_BruteToTournament" ALTER COLUMN "A" SET NOT NULL,
ALTER COLUMN "B" SET NOT NULL;

-- AlterTable
ALTER TABLE "_Opponents" ALTER COLUMN "A" SET NOT NULL,
ALTER COLUMN "B" SET NOT NULL;
