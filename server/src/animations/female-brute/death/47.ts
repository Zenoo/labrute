...
const femaleDeath47 = ({ colors, body }: FrameProps) => (/* html */`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
${body ? '' : ''}<svg xmlns:xlink="http://www.w3.org/1999/xlink" height="100px" width="100px" xmlns="http://www.w3.org/2000/svg">
  <g transform="matrix(1.0, 0.0, 0.0, 1.0, 47.3, 83.15)">
    <use height="163.4" transform="matrix(-0.3262, -0.1525, -0.1525, 0.3262, 33.0117, -49.0091)" width="66.2" xlink:href="#sprite0"/>
    ...
    <use height="113.0" transform="matrix(-0.3262, -0.1525, -0.1525, 0.3262, 46.2381, -42.607)" width="124.15" xlink:href="#sprite73"/>
