...
const femaleTrappedLoop18 = ({ colors, body }: FrameProps) => (/* html */`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
${body ? '' : ''}<svg xmlns:xlink="http://www.w3.org/1999/xlink" height="100px" width="150px" xmlns="http://www.w3.org/2000/svg">
  <g transform="matrix(1.0, 0.0, 0.0, 1.0, 55.9, 76.05)">
    ...
    <use height="59.0" transform="matrix(1.0, 0.0, 0.0129, 0.9651, -49.3304, -44.3201)" width="101.75" xlink:href="#sprite102"/>
  </g>
  <defs>
...
export default femaleTrappedLoop18;