...
const femaleEquip1 = ({ colors, body }: FrameProps) => (/* html */`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
${body ? '' : ''}<svg xmlns:xlink="http://www.w3.org/1999/xlink" height="100px" width="100px" xmlns="http://www.w3.org/2000/svg">
  <g transform="matrix(1.0, 0.0, 0.0, 1.0, 50.9, 90.55)">
    ...
    <use height="18.15" transform="matrix(0.3512, -0.0843, 0.0843, 0.3512, -4.8981, -46.1067)" width="17.85" xlink:href="#sprite8"/>
    ...
    <use height="50.85" transform="matrix(-0.2984, -0.2004, -0.2004, 0.2984, -1.2558, -15.5925)" width="32.25" xlink:href="#sprite46"/>
    <use height="29.15" transform="matrix(-0.3381, 0.0, 0.0, 0.3085, -2.6253, -28.0394)" width="30.4" xlink:href="#sprite50"/>
    <use height="46.15" transform="matrix(-0.3481, 0.0886, 0.0634, 0.2491, -6.2642, -24.7108)" width="27.4" xlink:href="#sprite55"/>
    <use height="53.3" transform="matrix(-0.2831, -0.1424, -0.1922, 0.3076, 3.3049, -25.7929)" width="65.0" xlink:href="#sprite59"/>
    <use height="47.7" transform="matrix(-0.3117, -0.1263, -0.1176, 0.2811, 5.5212, -34.9203)" width="62.75" xlink:href="#sprite65"/>
