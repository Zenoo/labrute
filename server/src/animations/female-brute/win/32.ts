...
const femaleWin32 = ({ colors, body }: FrameProps) => (/* html */`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
${body ? '' : ''}<svg xmlns:xlink="http://www.w3.org/1999/xlink" height="100px" width="100px" xmlns="http://www.w3.org/2000/svg">
  <g transform="matrix(1.0, 0.0, 0.0, 1.0, 50.5, 95.1)">
    <use height="163.4" transform="matrix(-0.3596, 0.0056, 0.0056, 0.3596, 3.1508, -76.2148)" width="66.2" xlink:href="#sprite0"/>
