...
const femaleDrink40 = ({ colors, body }: FrameProps) => (/* html */`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
${body ? '' : ''}<svg xmlns:xlink="http://www.w3.org/1999/xlink" height="100px" width="100px" xmlns="http://www.w3.org/2000/svg">
  <g transform="matrix(1.0, 0.0, 0.0, 1.0, 49.25, 90.2)">
    ...
    <use height="15.9" transform="matrix(-0.2627, -0.9623, 0.9624, -0.2627, 7.7841, -45.3385)" width="9.35" xlink:href="#sprite86"/>
    ...
    <use height="37.15" transform="matrix(-0.2957, 0.0497, 0.0497, 0.2957, 3.1142, -45.3965)" width="34.95" xlink:href="#sprite94"/>
