...
const femaleDrink9 = ({ colors, body }: FrameProps) => (/* html */`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
${body ? '' : ''}<svg xmlns:xlink="http://www.w3.org/1999/xlink" height="100px" width="100px" xmlns="http://www.w3.org/2000/svg">
  <g transform="matrix(1.0, 0.0, 0.0, 1.0, 49.25, 90.2)">
    ...
    <use height="34.4" transform="matrix(-0.354, 0.067, 0.067, 0.354, 17.0213, -38.6756)" width="31.55" xlink:href="#sprite4"/>
    <use height="126.95" transform="matrix(0.3512, -0.0843, 0.0843, 0.3512, 0.6216, -29.3395)" width="253.5" xlink:href="#sprite8"/>
    ...
    <use height="22.75" transform="matrix(0.0298, -0.3577, -0.3577, -0.0298, -1.982, -19.81)" width="24.65" xlink:href="#sprite86"/>
    <use height="30.4" transform="matrix(-0.2742, -0.2325, -0.2325, 0.2742, 2.5388, -40.3036)" width="20.05" xlink:href="#sprite89"/>
    <use height="37.15" transform="matrix(-0.2974, 0.0393, 0.0393, 0.2974, 4.4178, -46.9242)" width="34.95" xlink:href="#sprite93"/>
    <use height="34.75" transform="matrix(-0.3575, 0.0188, 0.0188, 0.3575, -0.2156, -38.3325)" width="35.85" xlink:href="#sprite97"/>
  </g>
  <defs>
