...
const femaleDrink25 = ({ colors, body }: FrameProps) => (/* html */`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
${body ? '' : ''}<svg xmlns:xlink="http://www.w3.org/1999/xlink" height="100px" width="100px" xmlns="http://www.w3.org/2000/svg">
  <g transform="matrix(1.0, 0.0, 0.0, 1.0, 49.25, 90.2)">
    ...
    <use height="15.9" transform="matrix(-0.3723, -0.9259, 0.9259, -0.3723, 7.0886, -45.9383)" width="9.35" xlink:href="#sprite86"/>
    ...
    <use height="37.15" transform="matrix(-0.2941, 0.0593, 0.0593, 0.2941, 2.3268, -45.3609)" width="34.95" xlink:href="#sprite94"/>
