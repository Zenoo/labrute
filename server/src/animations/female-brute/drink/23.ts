...
const femaleDrink23 = ({ colors, body }: FrameProps) => (/* html */`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
${body ? '' : ''}<svg xmlns:xlink="http://www.w3.org/1999/xlink" height="100px" width="100px" xmlns="http://www.w3.org/2000/svg">
  <g transform="matrix(1.0, 0.0, 0.0, 1.0, 49.25, 90.2)">
    ...
    <use height="15.9" transform="matrix(-0.309, -0.9482, 0.9482, -0.309, 7.5141, -45.5873)" width="9.35" xlink:href="#sprite86"/>
    ...
    <use height="37.15" transform="matrix(-0.2952, 0.0524, 0.0524, 0.2952, 2.8117, -45.3282)" width="34.95" xlink:href="#sprite94"/>
