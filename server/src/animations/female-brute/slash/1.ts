...
const femaleSlash1 = ({ colors, body }: FrameProps) => (/* html */`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
${body ? '' : ''}<svg xmlns:xlink="http://www.w3.org/1999/xlink" height="100px" width="150px" xmlns="http://www.w3.org/2000/svg">
  <g transform="matrix(1.0, 0.0, 0.0, 1.0, 54.55, 86.85)">
    ...
    <use height="126.95" transform="matrix(0.3017, -0.198, 0.198, 0.3017, -14.8253, -44.1306)" width="253.5" xlink:href="#sprite8"/>
