...
const femaleArriveStart1 = ({ colors, body }: FrameProps) => (/* html */`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
${body ? '' : ''}<svg xmlns:xlink="http://www.w3.org/1999/xlink" height="100px" width="100px" xmlns="http://www.w3.org/2000/svg">
  <g transform="matrix(1.0, 0.0, 0.0, 1.0, 48.4, 83.25)">
    <use height="163.4" transform="matrix(-0.0457, -0.3582, -0.3582, 0.0457, 13.1585, -56.2545)" width="66.2" xlink:href="#sprite0"/>
...
export default femaleArriveStart1;