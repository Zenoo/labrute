...
const maleDrink40 = ({ colors, body }: FrameProps) => (/* html */`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
${body ? '' : ''}<svg xmlns:xlink="http://www.w3.org/1999/xlink" height="100px" width="100px" xmlns="http://www.w3.org/2000/svg">
  <g transform="matrix(1.0, 0.0, 0.0, 1.0, 43.1, 82.75)">
    ...
    <use height="44.2" transform="matrix(-0.3639, -0.0319, -0.0378, 0.3584, 18.895, -43.3098)" width="79.15" xlink:href="#sprite63"/>
