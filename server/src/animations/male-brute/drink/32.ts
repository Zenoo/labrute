...
const maleDrink32 = ({ colors, body }: FrameProps) => (/* html */`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
${body ? '' : ''}<svg xmlns:xlink="http://www.w3.org/1999/xlink" height="100px" width="100px" xmlns="http://www.w3.org/2000/svg">
  <g transform="matrix(1.0, 0.0, 0.0, 1.0, 43.1, 82.75)">
    ...
    <use height="44.2" transform="matrix(-0.3843, -0.027, -0.0395, 0.3733, 19.492, -43.7887)" width="79.15" xlink:href="#sprite63"/>
    ...
    <use height="48.0" transform="matrix(-0.3398, -0.2049, -0.2049, 0.3398, 9.9027, -43.298)" width="56.75" xlink:href="#sprite92"/>
