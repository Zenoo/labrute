...
const maleSteal1 = ({ colors, body }: FrameProps) => (/* html */`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
${body ? '' : ''}<svg xmlns:xlink="http://www.w3.org/1999/xlink" height="100px" width="100px" xmlns="http://www.w3.org/2000/svg">
  <g transform="matrix(1.0, 0.0, 0.0, 1.0, 40.4, 82.95)">
    ...
    <use height="40.55" transform="matrix(-0.3975, -0.0278, -0.0278, 0.3975, -0.9586, -5.9302)" width="30.7" xlink:href="#sprite37"/>
    <use height="51.8" transform="matrix(-0.3392, -0.2065, -0.2065, 0.3392, 6.1982, -10.4818)" width="41.8" xlink:href="#sprite43"/>
    <use height="34.25" transform="matrix(-0.3987, 0.0, 0.0, 0.3987, 10.8109, -28.167)" width="46.3" xlink:href="#sprite47"/>
    <use height="45.0" transform="matrix(-0.288, -0.2735, -0.175, 0.1843, 6.7062, -14.5516)" width="29.7" xlink:href="#sprite52"/>
