...
const maleThrow8 = ({ colors, body }: FrameProps) => (/* html */`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
${body ? '' : ''}<svg xmlns:xlink="http://www.w3.org/1999/xlink" height="100px" width="100px" xmlns="http://www.w3.org/2000/svg">
  <g transform="matrix(1.0, 0.0, 0.0, 1.0, 30.4, 69.55)">
    ...
    <use height="18.15" transform="matrix(0.1046, 0.383, -0.383, 0.1046, 17.5203, -20.6201)" width="17.85" xlink:href="#sprite95"/>
  </g>
  <defs>
