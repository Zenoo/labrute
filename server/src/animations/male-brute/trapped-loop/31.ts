...
const maleTrappedLoop31 = ({ colors, body }: FrameProps) => (/* html */`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
${body ? '' : ''}<svg xmlns:xlink="http://www.w3.org/1999/xlink" height="150px" width="150px" xmlns="http://www.w3.org/2000/svg">
  <g transform="matrix(1.0, 0.0, 0.0, 1.0, 60.9, 106.8)">
    ...
    <use height="44.2" transform="matrix(-0.3778, 0.1231, 0.1231, 0.3778, 10.4048, -26.9356)" width="79.15" xlink:href="#sprite53"/>
    <use height="115.65" transform="matrix(-0.3342, -0.0281, -0.0281, 0.3342, 16.3325, -49.875)" width="108.25" xlink:href="#sprite60"/>
    <use height="26.45" transform="matrix(-0.3601, -0.1627, -0.1627, 0.3601, -14.5268, -6.1919)" width="23.2" xlink:href="#sprite73"/>
    <use height="30.75" transform="matrix(-0.2111, -0.3368, -0.3368, 0.2111, -2.6854, -10.7838)" width="40.3" xlink:href="#sprite77"/>
    <use height="48.0" transform="matrix(-0.2823, -0.2789, -0.2789, 0.2823, 4.6946, -16.3225)" width="56.75" xlink:href="#sprite81"/>
    <use height="61.05" transform="matrix(-0.326, -0.2248, -0.2249, 0.326, -2.8485, -17.3505)" width="64.0" xlink:href="#sprite85"/>
    ...
    <use height="59.0" transform="matrix(1.0, 0.0, 0.0268, 0.9865, -50.2404, -45.5503)" width="101.75" xlink:href="#sprite99"/>
  </g>
  <defs>
...
export default maleTrappedLoop31;