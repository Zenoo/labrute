...
const maleBruteIddle34 = ({ colors, body }: FrameProps) => (/* html */`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
${body ? '' : ''}<svg xmlns:xlink="http://www.w3.org/1999/xlink" height="66px" width="56px" xmlns="http://www.w3.org/2000/svg">
  <g transform="matrix(1.0, 0.0, 0.0, 1.0, 25, 58.8)">
    ...
    <use height="126.95" transform="matrix(0.3872, -0.093, 0.093, 0.3872, 3.9728, -32.6643)" width="253.5" xlink:href="#sprite5"/>
...
export default maleBruteIddle34;