...
const maleDeath19 = ({ colors, body }: FrameProps) => (/* html */`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
${body ? '' : ''}<svg xmlns:xlink="http://www.w3.org/1999/xlink" height="100px" width="100px" xmlns="http://www.w3.org/2000/svg">
  <g transform="matrix(1.0, 0.0, 0.0, 1.0, 45.7, 82.0)">
    ...
    <use height="115.65" transform="matrix(-0.272, -0.1978, -0.1978, 0.272, 50.5521, -40.2821)" width="108.25" xlink:href="#sprite70"/>
