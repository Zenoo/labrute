...
const maleEquip1 = ({ colors, body }: FrameProps) => (/* html */`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
${body ? '' : ''}<svg xmlns:xlink="http://www.w3.org/1999/xlink" height="100px" width="100px" xmlns="http://www.w3.org/2000/svg">
  <g transform="matrix(1.0, 0.0, 0.0, 1.0, 44.1, 82.35)">
    ...
    <use height="18.15" transform="matrix(0.3877, -0.0931, 0.0931, 0.3877, 15.3356, -29.7191)" width="17.85" xlink:href="#sprite5"/>
