...
export const LAST_RELEASE: Release = {
  ...
  date: '2024-11-23',
  features: [
    'Fight sound effects have been reworked. A lot have been added and they now  load faster',
    'New moderator panel',
    'A new option to display opponent stats on the arena page can be toggled in the user menu',
    'Users last activity is now displayed on the user view, brute cell view and clan brutes list. Green means online in the last 3 days, orange in the last week, red otherwise',
  ],
  fixes: [
