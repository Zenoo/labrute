...
export const LAST_RELEASE: Release = {
  ...
  features: [
    ...
    'A new search system has been implemented. You can now search for brutes by name. The search bar is available in the topbar.',
    'The endurance stat is now gone. It has been replaced by HP everywhere it was displayed. This should make it easier for new players to understand the game.',
    'Two new stats have been added: Critical Chance and Critical Damage. Critical Chance is the chance to deal a critical hit, and Critical Damage is the damage multiplier when a critical hit is dealt. Everyone has 5% base Critical Chance and 150% base Critical Damage.',
    'A new skill has been added: `Fast Metabolism`. Looking forward to hearing your feedback on this one! This skill starts the final line of skills that will be implemented in the game.',
    'The event page has been completely reworked. You can also see the current events in your user menu.',
  ],
  fixes: [
    'A LOT of security fixes.',
    'Hypnosis: use chance x2',
    'Armor: -10% speed ➡️ -15% speed',
    'Bodybuilder: +25% Hit speed (heavy) ➡️ +40% Hit speed (heavy)',
    'Survival: +20% block/evasion at 1HP',
    'Lead Skeleton: Damage -30% (blunt) ➡️ Damage -15% (blunt). +15% Armor, -15% evasion',
    'The Halbard is now a heavy weapon',
    'Weapons Master: Opponent spy can\'t swap sharp weapons',
    'Fierce Brute: +1 use per 30 STR',
    'Only focus opponent brute if hypnosis still available',
    'Defensive skills disabled when fierce brute is active',
    'Tragic potion activates at 50% HP lost, or 30% HP lost if poisoned',
    'Disable net if a pet available but other anti pets skills are available',
    'Consecutive hits (for chaining) reset by every damage but poison',
    'Initiative malus if woken up by getting hit by a skill',
    'Remove opponent initiative malus when stealing a weapon',
    'Increase initiative lost when using Tragic Potion',
    'Hypnosis: 90% chance to hypnotise each pet',
    'Fierce brute works with vampirism',
    'Always draw a weapon before using haste if one is available',
    'Increase block/evasion when survival procs',
    'Block chance capped at 90%',
    'Evasion chance capped at 90%',
    'Draw a weapon when fierce brute is active',
    'New animations for Fierce Brute, Haste, Flash Flood, Pilediver and Hypnosis',
    'New visuals for Shock and Resist',
    'Fighters now have a shadow',
    'Dropped weapons bounce off the ground',
    'New Sabotage and Saboteur visuals',
    'Fight positions have been optimized to maximize the space used',
    'New knockback effect on most animations',
    'The fight HUD now changes accordingly when the Backup is playing',
    'The ranking displayed on an event brute cell is now correct, and excludes non-event brutes',
    'Some animations have been repositioned, like some hit animations that were too low',
    'Fight texts when using the Brave browser are now correctly displayed',
    'Deleted brutes are now removed from your followed brutes',
    'Deleted brutes are now removed from clan war fighters',
    'Fighter names under clan war fights are now clickable',
    'Challenging the clan boss now generates a fight log in your cell'
  ],
  attachments: ['searchbar.png', 'eventPage.png'],
};
