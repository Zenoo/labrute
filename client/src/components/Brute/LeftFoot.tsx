          ...
          <>
            ...
            <defs>
              <g id="leftFoot" transform="matrix(1.0, 0.0, 0.0, 1.0, 20.0, 17.7)">
                <use height="40.55" transform="matrix(1.0, 0.0, 0.0, 1.0, -20.0, -17.7)" width="30.7" xlinkHref="#sprite41" />
              </g>
              <g id="sprite41" transform="matrix(1.0, 0.0, 0.0, 1.0, 18.7, 20.85)">
                <use height="35.6" id="_p7b" transform="matrix(1.0, 0.0, 0.0, 1.0, -18.7, -15.9)" width="29.3" xlinkHref="#sprite42" />
                <use height="33.4" id="_col0" transform="matrix(1.0, 0.0, 0.0, 1.0, -16.15, -20.0)" width="25.45" xlinkHref="#sprite43" />
                <use height="38.65" id="_p7" transform="matrix(1.0, 0.0, 0.0, 1.0, -18.2, -20.85)" width="30.2" xlinkHref="#sprite44" />
              </g>
              <g id="sprite43" transform="matrix(1.0, 0.0, 0.0, 1.0, 12.75, 16.7)">
                <use height="33.4" transform="matrix(1.0, 0.0, 0.0, 1.0, -12.75, -16.7)" width="25.45" xlinkHref="#shape9" />
              </g>
              ...
              <g id="sprite44" transform="matrix(1.0, 0.0, 0.0, 1.0, 15.25, 19.35)">
                <use height="38.65" id="_p1" transform="matrix(1.0, 0.0, 0.0, 1.0, -15.0, -19.35)" width="29.95" xlinkHref="#sprite45" />
              </g>
            </defs>
          </>
        );
        ...
        <>
          ...
          <defs>
            <g id="leftFoot" transform="matrix(1.0, 0.0, 0.0, 1.0, 20.3, 17.75)">
              <use height="45.1" transform="matrix(1.0, 0.0, 0.0, 1.0, -20.3, -17.75)" width="31.0" xlinkHref="#sprite41" />
            </g>
            <g id="sprite41" transform="matrix(1.0, 0.0, 0.0, 1.0, 19.0, 20.9)">
              <use height="40.1" id="_p7b" transform="matrix(1.0, 0.0, 0.0, 1.0, -19.0, -15.9)" width="29.6" xlinkHref="#sprite42" />
              <use height="33.4" id="_col0" transform="matrix(1.0, 0.0, 0.0, 1.0, -16.15, -20.0)" width="25.45" xlinkHref="#sprite43" />
              <use height="38.7" id="_p7" transform="matrix(1.0, 0.0, 0.0, 1.0, -17.95, -20.9)" width="29.95" xlinkHref="#sprite44" />
            </g>
            <g id="sprite43" transform="matrix(1.0, 0.0, 0.0, 1.0, 12.75, 16.7)">
              <use height="33.4" transform="matrix(1.0, 0.0, 0.0, 1.0, -12.75, -16.7)" width="25.45" xlinkHref="#shape13" />
            </g>
