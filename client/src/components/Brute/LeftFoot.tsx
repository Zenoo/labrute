...
const LeftFoot = ({ gender, colors, type }: LeftFootProps) => {
  if (gender === 'male') {
    switch (type) {
      case 1:
        return (
          <>
            <use height="40.55" transform="matrix(0.9969, -0.0697, 0.0697, 0.9969, 34.3782, 173.4983)" width="30.7" xlinkHref="#leftFoot" />
            <defs>
              <g id="leftFoot" transform="matrix(1.0, 0.0, 0.0, 1.0, 20.0, 17.7)">
                <use height="40.55" transform="matrix(1.0, 0.0, 0.0, 1.0, -20.0, -17.7)" width="30.7" xlinkHref="#leftFoot-sprite41" />
              </g>
              <g id="leftFoot-sprite41" transform="matrix(1.0, 0.0, 0.0, 1.0, 18.7, 20.85)">
                <use height="35.6" transform="matrix(1.0, 0.0, 0.0, 1.0, -18.7, -15.9)" width="29.3" xlinkHref="#leftFoot-sprite42" />
                <use height="33.4" transform="matrix(1.0, 0.0, 0.0, 1.0, -16.15, -20.0)" width="25.45" xlinkHref="#leftFoot-sprite43" />
                <use height="38.65" transform="matrix(1.0, 0.0, 0.0, 1.0, -18.2, -20.85)" width="30.2" xlinkHref="#leftFoot-sprite44" />
              </g>
              <g id="leftFoot-sprite43" transform="matrix(1.0, 0.0, 0.0, 1.0, 12.75, 16.7)">
                <use height="33.4" transform="matrix(1.0, 0.0, 0.0, 1.0, -12.75, -16.7)" width="25.45" xlinkHref="#leftFoot-shape9" />
              </g>
              <g id="leftFoot-shape9" transform="matrix(1.0, 0.0, 0.0, 1.0, 12.75, 16.7)">
              ...
              <g id="leftFoot-sprite44" transform="matrix(1.0, 0.0, 0.0, 1.0, 15.25, 19.35)">
                <use height="38.65" transform="matrix(1.0, 0.0, 0.0, 1.0, -15.0, -19.35)" width="29.95" xlinkHref="#leftFoot-sprite45" />
              </g>
            </defs>
          </>
        );
  ...
  switch (type) {
    case 1:
      return (
        <>
          <use height="45.1" transform="matrix(0.9178, -0.0642, 0.0642, 0.9178, 31.1301, 176.463)" width="31.0" xlinkHref="#leftFoot" />
          <defs>
            <g id="leftFoot" transform="matrix(1.0, 0.0, 0.0, 1.0, 20.3, 17.75)">
              <use height="45.1" transform="matrix(1.0, 0.0, 0.0, 1.0, -20.3, -17.75)" width="31.0" xlinkHref="#leftFoot-sprite41" />
            </g>
            <g id="leftFoot-sprite41" transform="matrix(1.0, 0.0, 0.0, 1.0, 19.0, 20.9)">
              <use height="40.1" transform="matrix(1.0, 0.0, 0.0, 1.0, -19.0, -15.9)" width="29.6" xlinkHref="#leftFoot-sprite42" />
              <use height="33.4" transform="matrix(1.0, 0.0, 0.0, 1.0, -16.15, -20.0)" width="25.45" xlinkHref="#leftFoot-sprite43" />
              <use height="38.7" transform="matrix(1.0, 0.0, 0.0, 1.0, -17.95, -20.9)" width="29.95" xlinkHref="#leftFoot-sprite44" />
            </g>
            <g id="leftFoot-sprite43" transform="matrix(1.0, 0.0, 0.0, 1.0, 12.75, 16.7)">
              <use height="33.4" transform="matrix(1.0, 0.0, 0.0, 1.0, -12.75, -16.7)" width="25.45" xlinkHref="#leftFoot-shape13" />
            </g>
            <g id="leftFoot-shape13" transform="matrix(1.0, 0.0, 0.0, 1.0, 12.75, 16.7)">
              <path d="M9.0 -12.95 L9.65 -9.55 9.8 -8.4 9.8 -7.25 Q9.95 -4.35 10.6 -1.25 11.25 1.65 12.4 4.75 L12.7 6.55 10.8 11.25 Q8.0 9.15 6.25 11.75 L5.9 12.55 4.75 11.4 5.9 12.55 6.25 11.75 Q8.0 9.15 10.8 11.25 L10.6 13.35 10.45 14.3 Q8.65 15.45 7.7 14.65 L6.05 13.5 Q5.9 17.25 1.85 16.6 -0.1 16.75 0.05 14.65 -1.7 17.55 -5.3 15.6 L-5.6 14.95 -4.95 12.4 -4.65 8.95 -4.95 12.4 -5.6 14.95 -7.55 16.45 -10.5 15.95 -12.45 14.3 -12.45 14.0 Q-12.1 12.7 -10.35 12.2 L-7.4 13.35 -6.45 13.2 -6.75 12.2 -6.25 10.9 -4.65 8.95 Q-4.15 8.95 -3.85 9.6 -3.5 10.25 -3.5 11.25 -4.55 11.55 -4.15 12.2 L-3.65 12.7 -3.65 13.2 -2.35 13.5 -2.05 13.35 -1.9 13.35 -0.1 13.5 -0.1 12.4 -0.1 12.05 0.2 11.4 0.7 12.2 1.7 13.05 1.7 13.35 1.85 13.85 3.95 13.85 1.85 13.85 1.7 13.35 3.95 13.85 4.45 13.65 4.6 13.2 4.6 11.4 4.75 11.4 6.25 7.65 3.15 3.45 1.05 -0.1 Q1.2 -2.55 1.5 -4.5 1.7 -6.6 0.85 -11.3 L-0.1 -16.5 -0.1 -16.7 Q3.0 -16.7 5.25 -15.85 L6.4 -15.4 7.7 -14.75 8.85 -13.6 Q8.85 -13.25 9.0 -12.95 M-0.1 13.5 L0.05 14.65 -0.1 13.5 M7.55 12.2 L7.85 11.9 Q8.85 11.9 9.0 12.55 L9.0 13.05 7.55 12.7 7.55 12.2 7.55 12.7 9.0 13.05 9.0 12.55 Q8.85 11.9 7.85 11.9 L7.55 12.2 M5.9 12.55 L6.05 13.5 5.9 12.55" fill={colors.skin.shade} fillRule="evenodd" stroke="none" />
            ...
            <g id="leftFoot-sprite44" transform="matrix(1.0, 0.0, 0.0, 1.0, 15.0, 19.4)">
              <use height="38.65" transform="matrix(1.0, 0.0, 0.0, 1.0, -15.0, -19.35)" width="29.95" xlinkHref="#leftFoot-sprite45" />
            </g>
          </defs>
        </>
