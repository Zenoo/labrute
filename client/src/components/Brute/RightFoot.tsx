          ...
          <>
            ...
            <defs>
              <g id="rightFoot" transform="matrix(1.0, 0.0, 0.0, 1.0, 13.2, 12.95)">
                <use height="38.95" id="_p8" transform="matrix(1.0, 0.0, 0.0, 1.0, -13.2, -12.95)" width="40.2" xlinkHref="#sprite24" />
              </g>
              <g id="sprite24" transform="matrix(1.0, 0.0, 0.0, 1.0, 15.2, 17.1)">
                <use height="27.4" id="_p7b" transform="matrix(1.0, 0.0, 0.0, 1.0, -15.2, -5.55)" width="40.2" xlinkHref="#sprite25" />
                <use height="32.1" id="_col0" transform="matrix(1.0, 0.0, 0.0, 1.0, -13.75, -16.35)" width="36.1" xlinkHref="#sprite26" />
                <use height="33.25" id="_p7" transform="matrix(1.0, 0.0, 0.0, 1.0, -14.4, -17.1)" width="36.8" xlinkHref="#sprite27" />
              </g>
              <g id="sprite26" transform="matrix(1.0, 0.0, 0.0, 1.0, 18.05, 16.05)">
                <use height="32.1" transform="matrix(1.0, 0.0, 0.0, 1.0, -18.05, -16.05)" width="36.1" xlinkHref="#shape6" />
              </g>
              ...
              <g id="sprite27" transform="matrix(1.0, 0.0, 0.0, 1.0, 19.6, 17.85)">
                <use height="33.25" id="_p1" transform="matrix(1.0, 0.0, 0.0, 1.0, -19.6, -17.85)" width="36.8" xlinkHref="#sprite28" />
              </g>
            </defs>
          </>
        );
        ...
        <>
          ...
          <defs>
            <g id="rightFoot" transform="matrix(1.0, 0.0, 0.0, 1.0, 13.2, 13.4)">
              <use height="43.7" id="_p8" transform="matrix(1.0, 0.0, 0.0, 1.0, -13.2, -13.4)" width="43.4" xlinkHref="#sprite24" />
            </g>
            <g id="sprite24" transform="matrix(1.0, 0.0, 0.0, 1.0, 15.2, 17.55)">
              <use height="31.7" id="_p7b" transform="matrix(1.0, 0.0, 0.0, 1.0, -15.2, -5.55)" width="40.2" xlinkHref="#sprite25" />
              <use height="32.1" id="_col0" transform="matrix(1.0, 0.0, 0.0, 1.0, -13.75, -16.35)" width="36.1" xlinkHref="#sprite26" />
              <use height="34.55" id="_p7" transform="matrix(1.0, 0.0, 0.0, 1.0, -14.4, -17.55)" width="42.6" xlinkHref="#sprite27" />
            </g>
            <g id="sprite26" transform="matrix(1.0, 0.0, 0.0, 1.0, 18.05, 16.05)">
              <use height="32.1" transform="matrix(1.0, 0.0, 0.0, 1.0, -18.05, -16.05)" width="36.1" xlinkHref="#shape9" />
            </g>
