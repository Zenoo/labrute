...
const LowerRightLeg = ({ gender, colors, type }: LowerRightLegProps) => {
  if (gender === 'male') {
    switch (type) {
      case 1:
        return (
          <>
            ...
            <defs>
              <g id="lowerRightLeg" transform="matrix(1.0, 0.0, 0.0, 1.0, 29.55, 4.4)">
                <use height="52.5" transform="matrix(1.0, 0.0, 0.0, 1.0, -29.55, -4.4)" width="53.85" xlinkHref="#lowerRightLeg-sprite30" />
              </g>
              <g id="lowerRightLeg-sprite30" transform="matrix(1.0, 0.0, 0.0, 1.0, 29.45, 20.8)">
                <use height="52.5" transform="matrix(1.0, 0.0, 0.0, 1.0, -24.0, -20.8)" width="43.9" xlinkHref="#lowerRightLeg-sprite31" />
              </g>
              <g id="lowerRightLeg-sprite31" transform="matrix(1.0, 0.0, 0.0, 1.0, 24.0, 20.8)">
                <use height="37.35" transform="matrix(1.0, 0.0, 0.0, 1.0, -8.0, -18.65)" width="16.0" xlinkHref="#lowerRightLeg-sprite32" />
                <use height="49.6" transform="matrix(0.9969, -0.0749, 0.0749, 0.9969, -24.0105, -17.758)" width="40.3" xlinkHref="#lowerRightLeg-sprite33" />
              </g>
              <g id="lowerRightLeg-sprite32" transform="matrix(1.0, 0.0, 0.0, 1.0, 8.0, 18.65)">
                <use height="37.35" transform="matrix(1.1594, 0.0, 0.0, 1.0, -8.0, -18.65)" width="13.8" xlinkHref="#lowerRightLeg-shape7" />
              </g>
              <g id="lowerRightLeg-shape7" transform="matrix(1.0, 0.0, 0.0, 1.0, 6.9, 18.65)">
              ...
              <g id="lowerRightLeg-sprite33" transform="matrix(1.0, 0.0, 0.0, 1.0, 23.05, 21.1)">
                <use height="33.65" transform="matrix(1.0203, -0.0668, 0.077, 1.1768, -16.3576, -19.0691)" width="30.4" xlinkHref="#sprite7-lower-right-leg" />
              </g>
              <g id="sprite7-lower-right-leg" transform="matrix(1.0, 0.0, 0.0, 1.0, 4.5, 6.05)">
                <use height="33.65" transform="matrix(1.0, 0.0, 0.0, 1.0, -4.5, -6.05)" width="30.4" xlinkHref="#shape1-lower-right-leg" />
              </g>
              <g id="shape1-lower-right-leg" transform="matrix(1.0, 0.0, 0.0, 1.0, 4.5, 6.05)">
        ...
        <>
          ...
          <defs>
            <g id="lowerRightLeg" transform="matrix(1.0, 0.0, 0.0, 1.0, 17.3, 4.3)">
              <use height="49.55" transform="matrix(1.0, 0.0, 0.0, 1.0, -17.3, -4.3)" width="36.6" xlinkHref="#lowerRightLeg-sprite30" />
            </g>
            <g id="lowerRightLeg-sprite30" transform="matrix(1.0, 0.0, 0.0, 1.0, 17.2, 20.7)">
              <use height="49.55" transform="matrix(1.0, 0.0, 0.0, 1.0, -17.2, -20.7)" width="36.6" xlinkHref="#lowerRightLeg-sprite31" />
            </g>
            <g id="lowerRightLeg-sprite31" transform="matrix(1.0, 0.0, 0.0, 1.0, 17.2, 20.7)">
              <use height="37.35" transform="matrix(1.0, 0.0, 0.0, 1.0, -6.9, -18.65)" width="13.8" xlinkHref="#lowerRightLeg-sprite32" />
              <use height="47.2" transform="matrix(0.9969, -0.0749, 0.0749, 0.9969, -17.1777, -18.2215)" width="33.15" xlinkHref="#lowerRightLeg-sprite33" />
            </g>
            <g id="lowerRightLeg-sprite32" transform="matrix(1.0, 0.0, 0.0, 1.0, 6.9, 18.65)">
              <use height="37.35" transform="matrix(1.0, 0.0, 0.0, 1.0, -6.9, -18.65)" width="13.8" xlinkHref="#lowerRightLeg-shape10" />
            </g>
            <g id="lowerRightLeg-shape10" transform="matrix(1.0, 0.0, 0.0, 1.0, 6.9, 18.65)">
            ...
            <g id="lowerRightLeg-sprite33" transform="matrix(1.0, 0.0, 0.0, 1.0, 16.2, 21.05)">
              <use height="33.65" transform="matrix(0.9408, 0.3967, -0.1349, 0.5595, -11.6672, -4.7199)" width="30.4" xlinkHref="#sprite7-lower-right-leg" />
            </g>
            <g id="sprite7-lower-right-leg" transform="matrix(1.0, 0.0, 0.0, 1.0, 4.5, 6.05)">
              <use height="33.65" transform="matrix(1.0, 0.0, 0.0, 1.0, -4.5, -6.05)" width="30.4" xlinkHref="#shape1-lower-right-leg" />
            </g>
