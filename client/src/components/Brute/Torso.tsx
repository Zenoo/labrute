...
const Torso = ({ gender, type }: TorsoProps) => {
  if (gender === 'male') {
    switch (type) {
      case 1:
        return (
          <>
            ...
            <defs>
              <g id="torso" transform="matrix(1.0, 0.0, 0.0, 1.0, 37.35, 19.95)">
                <use height="44.2" id="_p2" transform="matrix(1.0, 0.0, 0.0, 1.0, -37.35, -19.95)" width="79.15" xlinkHref="#sprite67" />
              </g>
              <g id="sprite67" transform="matrix(1.0, 0.0, 0.0, 1.0, 19.35, 4.05)">
                <use height="41.1" id="_p5" transform="matrix(1.0, 0.0, 0.0, 1.0, -7.5, -2.8)" width="54.35" xlinkHref="#sprite68" />
              </g>
              <g id="sprite68" transform="matrix(1.0, 0.0, 0.0, 1.0, 7.5, 2.8)">
                <use height="25.5" id="_p7b" transform="matrix(1.0, 0.0, 0.0, 1.0, -7.5, 0.5)" width="20.35" xlinkHref="#sprite69" />
                <use height="35.0" id="_col0" transform="matrix(0.9077, 0.0, 0.0, 0.9077, -0.0172, 0.0158)" width="39.75" xlinkHref="#sprite70" />
                <use height="41.1" id="_p7" transform="matrix(1.0, 0.0, 0.0, 1.0, -4.2, -2.8)" width="51.05" xlinkHref="#sprite71" />
              </g>
              <g id="sprite70" transform="matrix(1.0, 0.0, 0.0, 1.0, 19.85, 17.5)">
                <use height="35.0" transform="matrix(1.0, 0.0, 0.0, 1.0, -19.85, -17.5)" width="39.75" xlinkHref="#shape13" />
              </g>
              <g id="shape13" transform="matrix(1.0, 0.0, 0.0, 1.0, 19.85, 17.5)">
                <path d="M11.7 -16.6 L13.8 -16.15 17.95 -14.65 19.05 -13.85 19.75 -12.5 19.9 -10.65 Q19.85 -9.1 19.4 -7.6 18.55 -4.9 17.05 -2.35 L14.1 2.45 Q12.7 4.5 10.9 6.2 L4.95 13.8 4.7 14.1 Q2.65 15.75 0.15 16.4 L-1.0 16.7 -2.3 17.0 -4.55 17.3 -6.75 17.5 -6.75 17.45 Q-5.75 14.95 -5.4 12.35 L-4.9 10.55 -4.45 9.4 Q-3.6 7.5 -5.3 6.3 L-5.45 5.95 -5.1 5.75 -4.2 5.55 -1.7 4.65 Q0.75 3.65 2.75 2.0 L4.85 0.35 7.4 -1.6 Q9.35 -3.15 11.15 -4.85 L12.65 -6.55 13.4 -8.0 Q13.6 -8.6 13.4 -9.15 12.4 -12.05 9.4 -12.4 L7.7 -12.15 5.65 -11.3 1.25 -9.2 Q-1.15 -8.1 -3.7 -7.55 L-5.95 -7.5 Q-7.45 -7.85 -8.5 -9.0 L-9.0 -9.95 Q-9.35 -11.15 -8.75 -12.35 L-7.15 -15.5 Q-5.7 -16.35 -3.45 -16.8 L-3.2 -16.85 1.5 -17.5 1.65 -17.5 10.9 -16.7 11.55 -16.6 11.7 -16.6" fill="#c6886a" fillRule="evenodd" stroke="none" />
              ...
              <g id="sprite71" transform="matrix(1.0, 0.0, 0.0, 1.0, 20.8, 17.95)">
                <use height="33.6" id="_p1" transform="matrix(1.0, 0.0, 0.0, 1.0, -19.35, -15.85)" width="40.9" xlinkHref="#sprite72" />
              </g>
              <g id="sprite72" transform="matrix(1.0, 0.0, 0.0, 1.0, 19.35, 15.85)">
                <use height="31.7" transform="matrix(1.0, 0.0, 0.0, 1.0, -19.3, -15.85)" width="38.65" xlinkHref="#shape14" />
              </g>
        ...
        <>
          ...
          <defs>
            <g id="torso" transform="matrix(1.0, 0.0, 0.0, 1.0, 26.0, 22.25)">
              <use height="47.7" id="_p2" transform="matrix(1.0, 0.0, 0.0, 1.0, -26.0, -22.25)" width="62.75" xlinkHref="#sprite66" />
            </g>
            <g id="sprite66" transform="matrix(1.0, 0.0, 0.0, 1.0, 8.0, 6.35)">
              <use height="47.7" id="_p5" transform="matrix(1.0, 0.0, 0.0, 1.0, -8.0, -6.35)" width="62.75" xlinkHref="#sprite67" />
            </g>
            <g id="sprite67" transform="matrix(1.0, 0.0, 0.0, 1.0, 8.0, 6.35)">
              <use height="25.5" id="_p7b" transform="matrix(1.0, 0.0, 0.0, 1.0, -8.0, 0.5)" width="17.6" xlinkHref="#sprite68" />
              <use height="35.0" id="_col0" transform="matrix(0.9077, 0.0, 0.0, 0.9077, -2.1503, 0.0158)" width="41.35" xlinkHref="#sprite69" />
              <use height="47.7" id="_p7" transform="matrix(1.0, 0.0, 0.0, 1.0, -4.65, -6.35)" width="59.4" xlinkHref="#sprite70" />
            </g>
            <g id="sprite69" transform="matrix(1.0, 0.0, 0.0, 1.0, 22.2, 17.5)">
              <use height="35.0" transform="matrix(1.0, 0.0, 0.0, 1.0, -22.2, -17.5)" width="41.35" xlinkHref="#shape16" />
            </g>
            ...
            <g id="sprite70" transform="matrix(1.0, 0.0, 0.0, 1.0, 21.25, 21.5)">
              <use height="32.9" id="_p1" transform="matrix(1.0, 0.0, 0.0, 1.0, -21.25, -15.9)" width="35.4" xlinkHref="#sprite71" />
            </g>
            <g id="sprite71" transform="matrix(1.0, 0.0, 0.0, 1.0, 21.25, 15.9)">
              <use height="26.0" transform="matrix(1.0, 0.0, 0.0, 1.0, -21.25, -15.9)" width="24.3" xlinkHref="#shape17" />
              <use height="18.6" id="_col2" transform="matrix(1.0, 0.0, 0.0, 1.0, -18.45, -8.95)" width="18.1" xlinkHref="#sprite72" />
              <use height="32.35" transform="matrix(1.0, 0.0, 0.0, 1.0, -7.6, -15.35)" width="21.75" xlinkHref="#shape19" />
            </g>
            ...
            <g id="sprite72" transform="matrix(1.0, 0.0, 0.0, 1.0, 9.05, 9.25)">
              <use height="18.6" transform="matrix(1.0, 0.0, 0.0, 1.0, -9.05, -9.25)" width="18.1" xlinkHref="#shape18" />
            </g>
            <g id="shape18" transform="matrix(1.0, 0.0, 0.0, 1.0, 9.05, 9.25)">
              <path d="M-8.85 -3.05 Q-8.35 -5.6 -6.45 -6.95 L-3.4 -8.95 -2.25 -9.25 0.35 -8.95 3.7 -8.3 9.05 -7.5 Q6.0 -4.85 4.75 -3.0 3.5 -1.15 2.95 1.05 L0.95 -0.25 -2.8 -2.55 -3.8 -3.0 -7.5 -3.2 -8.85 -3.05" fill="#ffffff" fillRule="evenodd" stroke="none" />
              <path d="M2.95 1.05 L2.9 1.35 2.8 1.8 Q2.55 3.1 2.55 4.5 2.55 6.55 2.95 9.25 L2.9 9.3 -3.65 4.8 Q-5.25 3.7 -7.65 3.6 -9.05 2.15 -9.05 0.6 L-9.05 -1.4 -9.0 -2.05 -8.85 -3.05 -7.5 -3.2 -3.8 -3.0 -2.8 -2.55 0.95 -0.25 2.95 1.05" fill="#d6baba" fillRule="evenodd" stroke="none" />
