...
const LowerLeftLeg = ({ gender, colors, type }: LowerLeftLegProps) => {
  if (gender === 'male') {
    switch (type) {
      case 1:
        return (
          <>
            ...
            <defs>
              <g id="lowerLeftLeg" transform="matrix(1.0, 0.0, 0.0, 1.0, 19.75, 4.6)">
                <use height="51.8" transform="matrix(1.0, 0.0, 0.0, 1.0, -19.75, -4.6)" width="41.8" xlinkHref="#lowerLeftLeg-sprite47" />
              </g>
              <g id="lowerLeftLeg-sprite47" transform="matrix(1.0, 0.0, 0.0, 1.0, 19.65, 21.0)">
                <use height="51.8" transform="matrix(1.0, 0.0, 0.0, 1.0, -15.8, -21.0)" width="33.6" xlinkHref="#lowerLeftLeg-sprite48" />
              </g>
              <g id="lowerLeftLeg-sprite48" transform="matrix(1.0, 0.0, 0.0, 1.0, 15.8, 21.0)">
                ...
                <use height="51.8" transform="matrix(1.0, 0.0, 0.0, 1.0, -15.8, -21.0)" width="33.6" xlinkHref="#lowerLeftLeg-sprite49" />
              </g>
              <g id="lowerLeftLeg-sprite49" transform="matrix(1.0, 0.0, 0.0, 1.0, 16.35, 22.55)">
                <use height="33.65" transform="matrix(1.0203, -0.0668, 0.077, 1.1768, -16.3576, -19.0691)" width="30.4" xlinkHref="#sprite7-lower-left-leg" />
              </g>
              <g id="sprite7-lower-left-leg" transform="matrix(1.0, 0.0, 0.0, 1.0, 4.5, 6.05)">
                <use height="33.65" transform="matrix(1.0, 0.0, 0.0, 1.0, -4.5, -6.05)" width="30.4" xlinkHref="#shape1-lower-left-leg" />
              </g>
              <g id="shape1-lower-left-leg" transform="matrix(1.0, 0.0, 0.0, 1.0, 4.5, 6.05)">
        ...
        <>
          ...
          <defs>
            <g id="lowerLeftLeg" transform="matrix(1.0, 0.0, 0.0, 1.0, 15.55, 10.25)">
              <use height="50.85" transform="matrix(1.0, 0.0, 0.0, 1.0, -15.55, -10.25)" width="32.25" xlinkHref="#lowerLeftLeg-sprite47" />
            </g>
            <g id="lowerLeftLeg-sprite47" transform="matrix(1.0, 0.0, 0.0, 1.0, 15.45, 26.65)">
              <use height="50.85" transform="matrix(1.0, 0.0, 0.0, 1.0, -15.45, -26.65)" width="32.25" xlinkHref="#lowerLeftLeg-sprite48" />
            </g>
            <g id="lowerLeftLeg-sprite48" transform="matrix(1.0, 0.0, 0.0, 1.0, 15.45, 26.65)">
              {/* This next path is declared in LowerRightLeg and shared here */}
              <use height="37.35" transform="matrix(1.0, 0.0, 0.0, 1.0, -6.9, -18.65)" width="13.8" xlinkHref="#lowerRightLeg-sprite32" />
              <use height="50.85" transform="matrix(1.0, 0.0, 0.0, 1.0, -15.45, -26.65)" width="32.25" xlinkHref="#lowerLeftLeg-sprite49" />
            </g>
            <g id="lowerLeftLeg-sprite49" transform="matrix(1.0, 0.0, 0.0, 1.0, 16.0, 28.2)">
              <use height="33.65" transform="matrix(1.021, 0.0492, 0.0358, 0.6471, -16.0109, -1.5864)" width="30.4" xlinkHref="#sprite7-lower-left-leg" />
            </g>
            <g id="sprite7-lower-left-leg" transform="matrix(1.0, 0.0, 0.0, 1.0, 4.5, 6.05)">
              <use height="33.65" transform="matrix(1.0, 0.0, 0.0, 1.0, -4.5, -6.05)" width="30.4" xlinkHref="#shape1-lower-left-leg" />
            </g>
