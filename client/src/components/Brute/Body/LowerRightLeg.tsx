          ...
          <>
            ...
            <defs>
              ...
              <g id={`${id}-lowerRightLeg-shape7`} transform="matrix(1.0, 0.0, 0.0, 1.0, 6.9, 18.65)">
                <path d="M0.05 -18.6 Q3.4 -18.45 5.5 -16.1 L5.95 -15.65 6.9 -13.35 6.75 12.25 Q6.45 14.0 5.75 15.25 4.05 18.45 0.3 18.7 -0.7 11.7 -0.55 11.15 L0.15 -5.25 0.05 -18.6" fill={colors.secondaryShade} fillRule="evenodd" stroke="none" />
                <path d="M0.05 -18.6 L0.15 -5.25 -0.55 11.15 Q-0.7 11.7 0.3 18.7 -3.55 17.8 -5.25 16.05 -6.8 14.5 -6.65 12.15 L-6.9 -13.5 -5.45 -16.15 -4.05 -17.4 Q-2.4 -18.9 0.05 -18.6" fill={colors.secondaryColor} fillRule="evenodd" stroke="none" />
        ...
        <>
          ...
          <defs>
            ...
            <g id={`${id}-lowerRightLeg-shape10`} transform="matrix(1.0, 0.0, 0.0, 1.0, 6.9, 18.65)">
              <path d="M0.05 -18.6 Q3.4 -18.45 5.5 -16.1 L5.95 -15.65 6.9 -13.35 6.75 12.25 Q6.45 14.0 5.75 15.25 4.05 18.45 0.3 18.7 -0.7 11.7 -0.55 11.15 L0.15 -5.25 0.05 -18.6" fill={colors.skinShade} fillRule="evenodd" stroke="none" />
              <path d="M0.05 -18.6 L0.15 -5.25 -0.55 11.15 Q-0.7 11.7 0.3 18.7 -3.55 17.8 -5.25 16.05 -6.8 14.5 -6.65 12.15 L-6.9 -13.5 -5.45 -16.15 -4.05 -17.4 Q-2.4 -18.9 0.05 -18.6" fill={colors.skinColor} fillRule="evenodd" stroke="none" />
              <path d="M5.75 15.25 Q6.45 14.0 6.75 12.25 L6.9 -13.35 5.95 -15.65 M-5.45 -16.15 L-6.9 -13.5 -6.65 12.15 Q-6.8 14.5 -5.25 16.05" fill="none" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.3019608" strokeWidth="0.05" />
            </g>
