          ...
          <>
            ...
            <defs>
              ...
              <g id={`${id}-upperRightLeg-shape8`} transform="matrix(1.0, 0.0, 0.0, 1.0, 8.2, 18.65)">
                <path d="M-0.6 15.15 L-0.55 11.35 -0.3 5.8 Q0.0 0.55 0.15 -5.25 L0.05 -18.6 Q3.95 -18.45 6.35 -16.1 L6.9 -15.65 8.0 -13.35 9.0 7.6 Q8.5 10.9 6.2 12.6 3.85 14.25 -0.6 15.15" fill={colors.primaryShade} fillRule="evenodd" stroke="none" />
                <path d="M-0.6 15.15 Q-3.15 14.9 -4.9 14.0 -6.65 13.05 -7.6 10.95 -8.55 8.9 -8.0 3.75 L-8.0 -13.5 Q-7.25 -15.05 -6.3 -16.15 L-4.7 -17.4 Q-2.8 -18.9 0.05 -18.6 L0.15 -5.25 Q0.0 0.55 -0.3 5.8 L-0.55 11.35 -0.6 15.15" fill={colors.primaryColor} fillRule="evenodd" stroke="none" />
        ...
        <>
          ...
          <defs>
            ...
            <g id={`${id}-upperRightLeg-shape11`} transform="matrix(1.0, 0.0, 0.0, 1.0, 8.4, 18.65)">
              <path d="M0.35 18.7 Q-0.8 11.7 -0.65 11.15 -0.1 3.65 0.15 -5.25 L0.05 -18.6 Q3.95 -18.45 6.35 -16.1 L6.9 -15.65 8.0 -13.35 Q8.95 -2.1 7.25 12.75 7.05 14.2 5.9 16.35 4.7 18.45 0.35 18.7" fill={colors.skinShade} fillRule="evenodd" stroke="none" />
              <path d="M0.05 -18.6 L0.15 -5.25 Q-0.1 3.65 -0.65 11.15 -0.8 11.7 0.35 18.7 -4.1 17.8 -5.65 16.3 -7.25 14.75 -7.3 12.05 -9.05 0.05 -8.0 -13.5 -7.25 -15.05 -6.3 -16.15 L-4.7 -17.4 Q-2.8 -18.9 0.05 -18.6" fill={colors.skinColor} fillRule="evenodd" stroke="none" />
            ...
            <g id={`${id}-upperRightLeg-shape12`} transform="matrix(1.0, 0.0, 0.0, 1.0, 8.85, 18.65)">
              <path d="M0.05 -18.6 Q3.95 -18.45 6.35 -16.1 L6.9 -15.65 8.0 -13.35 Q8.55 -8.55 8.55 -3.7 L8.55 -1.6 8.45 -1.6 7.8 5.8 Q7.75 8.15 5.85 9.6 3.9 11.05 -0.5 10.8 L-0.55 9.25 -0.3 3.7 0.0 -2.4 0.05 -4.5 0.15 -4.5 0.15 -5.25 0.05 -18.6 M8.55 -3.7 L8.45 -1.6 8.55 -3.7" fill={colors.primaryShade} fillRule="evenodd" stroke="none" />
              <path d="M0.05 -18.6 L0.15 -5.25 0.15 -4.5 0.05 -4.5 0.0 -2.4 -0.3 3.7 -0.55 9.25 -0.5 10.8 Q-3.0 10.45 -4.85 9.55 -6.75 8.65 -7.7 7.2 -8.65 5.75 -8.6 1.8 L-8.6 1.7 -8.85 -3.25 -8.85 -4.3 -8.85 -3.25 -8.85 -4.3 -8.85 -5.35 -8.8 -5.35 -8.65 -7.9 -8.0 -13.5 Q-7.25 -15.05 -6.3 -16.15 L-4.7 -17.4 Q-2.8 -18.9 0.05 -18.6" fill={colors.primaryColor} fillRule="evenodd" stroke="none" />
