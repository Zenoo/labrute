...
const Torso = ({ id, gender, colors, type }: TorsoProps) => {
        ...
        return (
          <>
            ...
            <defs>
              ...
              <g id={`${id}-torso-sprite71`} transform="matrix(1.0, 0.0, 0.0, 1.0, 20.8, 17.95)">
                <use height="33.6" transform="matrix(1.0, 0.0, 0.0, 1.0, -19.35, -15.85)" width="40.9" xlinkHref={`#${id}-torso-sprite72`} />
              </g>
              <g id={`${id}-torso-sprite72`} transform="matrix(1.0, 0.0, 0.0, 1.0, 19.35, 15.85)">
                <use height="31.7" transform="matrix(1.0, 0.0, 0.0, 1.0, -19.3, -15.85)" width="38.65" xlinkHref={`#${id}-torso-shape14`} />
              </g>
              <g id={`${id}-torso-shape14`} transform="matrix(1.0, 0.0, 0.0, 1.0, 19.3, 15.85)">
  ...
  switch (type) {
    case 1:
      return (
        <>
          <use height="47.7" transform="matrix(0.9218, 0.0, -0.0995, 0.8353, 15.9468, 75.8153)" width="62.75" xlinkHref={`#${id}-torso`} />
          <defs>
            <g id={`${id}-torso`} transform="matrix(1.0, 0.0, 0.0, 1.0, 26.0, 22.25)">
              <use height="47.7" transform="matrix(1.0, 0.0, 0.0, 1.0, -26.0, -22.25)" width="62.75" xlinkHref={`#${id}-torso-sprite66`} />
            </g>
            <g id={`${id}-torso-sprite66`} transform="matrix(1.0, 0.0, 0.0, 1.0, 8.0, 6.35)">
              <use height="47.7" transform="matrix(1.0, 0.0, 0.0, 1.0, -8.0, -6.35)" width="62.75" xlinkHref={`#${id}-torso-sprite67`} />
            </g>
            <g id={`${id}-torso-sprite67`} transform="matrix(1.0, 0.0, 0.0, 1.0, 8.0, 6.35)">
              <use height="25.5" transform="matrix(1.0, 0.0, 0.0, 1.0, -8.0, 0.5)" width="17.6" xlinkHref={`#${id}-torso-sprite68`} />
              <use height="35.0" transform="matrix(0.9077, 0.0, 0.0, 0.9077, -2.1503, 0.0158)" width="41.35" xlinkHref={`#${id}-torso-sprite69`} />
              <use height="47.7" transform="matrix(1.0, 0.0, 0.0, 1.0, -4.65, -6.35)" width="59.4" xlinkHref={`#${id}-torso-sprite70`} />
            </g>
            <g id={`${id}-torso-sprite69`} transform="matrix(1.0, 0.0, 0.0, 1.0, 22.2, 17.5)">
              <use height="35.0" transform="matrix(1.0, 0.0, 0.0, 1.0, -22.2, -17.5)" width="41.35" xlinkHref={`#${id}-torso-shape16`} />
            </g>
            <g id={`${id}-torso-shape16`} transform="matrix(1.0, 0.0, 0.0, 1.0, 22.2, 17.5)">
            ...
            <g id={`${id}-torso-sprite70`} transform="matrix(1.0, 0.0, 0.0, 1.0, 21.25, 21.5)">
              <use height="32.9" transform="matrix(1.0, 0.0, 0.0, 1.0, -21.25, -15.9)" width="35.4" xlinkHref={`#${id}-torso-sprite71`} />
            </g>
            <g id={`${id}-torso-sprite71`} transform="matrix(1.0, 0.0, 0.0, 1.0, 21.25, 15.9)">
              <use height="26.0" transform="matrix(1.0, 0.0, 0.0, 1.0, -21.25, -15.9)" width="24.3" xlinkHref={`#${id}-torso-shape17`} />
              <use height="18.6" transform="matrix(1.0, 0.0, 0.0, 1.0, -18.45, -8.95)" width="18.1" xlinkHref={`#${id}-torso-sprite72`} />
              <use height="32.35" transform="matrix(1.0, 0.0, 0.0, 1.0, -7.6, -15.35)" width="21.75" xlinkHref={`#${id}-torso-shape19`} />
            </g>
            <g id={`${id}-torso-shape17`} transform="matrix(1.0, 0.0, 0.0, 1.0, 21.25, 15.9)">
            ...
            <g id={`${id}-torso-sprite72`} transform="matrix(1.0, 0.0, 0.0, 1.0, 9.05, 9.25)">
              <use height="18.6" transform="matrix(1.0, 0.0, 0.0, 1.0, -9.05, -9.25)" width="18.1" xlinkHref={`#${id}-torso-shape18`} />
            </g>
            <g id={`${id}-torso-shape18`} transform="matrix(1.0, 0.0, 0.0, 1.0, 9.05, 9.25)">
              <path d="M-8.85 -3.05 Q-8.35 -5.6 -6.45 -6.95 L-3.4 -8.95 -2.25 -9.25 0.35 -8.95 3.7 -8.3 9.05 -7.5 Q6.0 -4.85 4.75 -3.0 3.5 -1.15 2.95 1.05 L0.95 -0.25 -2.8 -2.55 -3.8 -3.0 -7.5 -3.2 -8.85 -3.05" fill={colors.primaryColor} fillRule="evenodd" stroke="none" />
              <path d="M2.95 1.05 L2.9 1.35 2.8 1.8 Q2.55 3.1 2.55 4.5 2.55 6.55 2.95 9.25 L2.9 9.3 -3.65 4.8 Q-5.25 3.7 -7.65 3.6 -9.05 2.15 -9.05 0.6 L-9.05 -1.4 -9.0 -2.05 -8.85 -3.05 -7.5 -3.2 -3.8 -3.0 -2.8 -2.55 0.95 -0.25 2.95 1.05" fill={colors.primaryShade} fillRule="evenodd" stroke="none" />
            ...
            <g id={`${id}-torso-shape19`} transform="matrix(1.0, 0.0, 0.0, 1.0, 7.6, 15.35)">
