          ...
          <>
            ...
            <defs>
              ...
              <g id={`${id}-rightShoulder-shape5`} transform="matrix(1.0, 0.0, 0.0, 1.0, 7.0, 7.05)">
                <path d="M1.05 7.0 Q2.3 5.95 3.0 3.85 L3.85 -1.05 Q3.75 -3.05 1.1 -6.05 L0.4 -6.9 Q0.6 -7.15 0.7 -6.9 L0.95 -6.9 Q4.1 -6.6 5.85 -4.25 7.35 -2.15 6.9 1.2 6.55 3.6 4.95 5.2 L4.35 5.75 Q3.2 6.65 1.95 6.9 L1.05 7.0" fill={colors.skinShade} fillRule="evenodd" stroke="none" />
                <path d="M0.4 -6.9 L1.1 -6.05 Q3.75 -3.05 3.85 -1.05 L3.0 3.85 Q2.3 5.95 1.05 7.0 L0.95 7.05 0.8 7.05 -1.15 6.95 -1.4 6.7 Q-4.05 6.25 -5.55 4.25 -6.85 2.5 -6.9 0.45 L-7.0 -1.2 Q-6.5 -3.55 -4.9 -5.15 -4.75 -5.55 -4.2 -5.75 -3.55 -6.4 -2.6 -6.55 -1.25 -7.25 0.4 -6.9" fill={colors.skinColor} fillRule="evenodd" stroke="none" />
        ...
        <>
          ...
          <defs>
            ...
            <g id={`${id}-rightShoulder-shape8`} transform="matrix(1.0, 0.0, 0.0, 1.0, 6.95, 6.95)">
              <path d="M0.4 -6.9 Q2.15 -6.95 3.7 -5.9 L5.6 -4.1 Q6.35 -3.05 6.6 -1.7 L6.85 1.2 Q6.75 2.95 5.65 4.3 L4.95 5.2 4.35 5.75 Q3.2 6.65 1.95 6.9 L1.05 7.0 Q2.3 5.95 3.0 3.85 L3.85 -1.05 Q3.75 -3.05 1.1 -6.05 L0.4 -6.9" fill={colors.skinShade} fillRule="evenodd" stroke="none" />
              <path d="M0.4 -6.9 L1.1 -6.05 Q3.75 -3.05 3.85 -1.05 L3.0 3.85 Q2.3 5.95 1.05 7.0 L0.95 7.05 0.8 7.05 -1.15 6.95 -1.4 6.7 Q-4.05 6.25 -5.55 4.25 -6.55 2.95 -6.8 1.45 -7.2 -0.5 -6.65 -2.3 -6.05 -4.2 -4.55 -5.45 L-3.45 -6.25 -2.8 -6.5 0.4 -6.9" fill={colors.skinColor} fillRule="evenodd" stroke="none" />
