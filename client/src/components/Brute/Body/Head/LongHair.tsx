...
const LongHair = ({ id, gender, colors, type }: LongHairProps) => {
  ...
  switch (type) {
    case 1:
      return (
        <>
          <use height="163.4" transform="matrix(0.9897, 0.0, 0.0, 0.9897, 32.0407, -5.8605)" width="66.2" xlinkHref={`#${id}-longHair`} />
          <defs>
            <g id={`${id}-longHair`} transform="matrix(1.0, 0.0, 0.0, 1.0, 28.35, 96.5)">
              <use height="163.4" transform="matrix(1.0, 0.0, 0.0, 1.0, -28.35, -96.5)" width="66.2" xlinkHref={`#${id}-longHair-sprite1`} />
            </g>
            <g id={`${id}-longHair-sprite1`} transform="matrix(1.0, 0.0, 0.0, 1.0, 107.05, 103.4)">
              <use height="90.15" transform="matrix(1.0, 0.0, 0.0, 1.0, -93.35, -89.7)" width="52.5" xlinkHref={`#${id}-longHair-sprite2`} />
              <use height="27.4" transform="matrix(1.0, 0.0, 0.0, 1.0, -90.6, -85.15)" width="27.4" xlinkHref={`#${id}-longHair-sprite3`} />
              <use height="8.3" transform="matrix(1.0, 0.0, 0.0, 1.0, -87.4, -81.85)" width="7.2" xlinkHref={`#${id}-longHair-shape2`} />
            </g>
            <g id={`${id}-longHair-sprite2`} transform="matrix(1.0, 0.0, 0.0, 1.0, 26.25, 45.1)">
              <use height="90.15" transform="matrix(1.0, 0.0, 0.0, 1.0, -26.25, -45.1)" width="52.5" xlinkHref={`#${id}-longHair-shape0`} />
            </g>
            <g id={`${id}-longHair-shape0`} transform="matrix(1.0, 0.0, 0.0, 1.0, 26.25, 45.1)">
            ...
            <g id={`${id}-longHair-sprite3`} transform="matrix(1.0, 0.0, 0.0, 1.0, 13.7, 13.7)">
              <use height="27.4" transform="matrix(1.0, 0.0, 0.0, 1.0, -13.7, -13.7)" width="27.4" xlinkHref={`#${id}-longHair-shape1`} />
            </g>
            <g id={`${id}-longHair-shape1`} transform="matrix(1.0, 0.0, 0.0, 1.0, 13.7, 13.7)">
            ...
            <g id={`${id}-longHair-shape2`} transform="matrix(1.0, 0.0, 0.0, 1.0, -16.7, 21.25)">
