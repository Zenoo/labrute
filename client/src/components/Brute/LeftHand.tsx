...
const LeftHand = ({ gender, type }: LeftHandProps) => {
  if (gender === 'male') {
    switch (type) {
      case 1:
        return (
          <>
            ...
            <defs>
              <g id="leftHand" transform="matrix(1.0, 0.0, 0.0, 1.0, 14.9, 4.35)">
                <use height="26.45" id="_p5" transform="matrix(1.0, 0.0, 0.0, 1.0, -14.9, -4.35)" width="23.2" xlinkHref="#sprite87" />
              </g>
              <g id="sprite87" transform="matrix(1.0, 0.0, 0.0, 1.0, 14.15, 7.5)">
                <use height="22.7" id="_col0" transform="matrix(1.0, 0.0, 0.0, 1.0, -13.6, -3.75)" width="21.65" xlinkHref="#sprite88" />
                <use height="26.45" id="_p7" transform="matrix(1.0, 0.0, 0.0, 1.0, -14.15, -7.5)" width="23.2" xlinkHref="#sprite89" />
              </g>
              <g id="sprite88" transform="matrix(1.0, 0.0, 0.0, 1.0, 13.6, 3.75)">
                <use height="22.7" transform="matrix(1.0, 0.0, 0.0, 1.0, -13.6, -3.75)" width="21.65" xlinkHref="#shape23" />
              </g>
