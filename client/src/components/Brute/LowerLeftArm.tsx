import { BodyColors, Gender } from '@backend/types';
...
const LowerLeftArm = ({ gender, colors, type }: LowerLeftArmProps) => {
  if (gender === 'male') {
    switch (type) {
      case 1:
        return (
          <>
            ...
            <defs>
              <g id="lowerLeftArm" transform="matrix(1.0, 0.0, 0.0, 1.0, 21.95, 34.0)">
                <use height="62.85" transform="matrix(1.0, 0.0, 0.0, 1.0, -21.95, -34.0)" width="64.1" xlinkHref="#lowerLeftArm-sprite95" />
              </g>
              <g id="lowerLeftArm-sprite95" transform="matrix(1.0, 0.0, 0.0, 1.0, 21.95, 34.0)">
                <use height="62.85" transform="matrix(1.0, 0.0, 0.0, 1.0, -14.2, -34.0)" width="43.35" xlinkHref="#lowerLeftArm-sprite96" />
              </g>
              <g id="lowerLeftArm-sprite96" transform="matrix(1.0, 0.0, 0.0, 1.0, 14.2, 34.0)">
                <use height="28.0" transform="matrix(0.9918, 0.1221, -0.1221, 0.9918, -3.8281, -14.5535)" width="11.15" xlinkHref="#lowerLeftArm-sprite5" />
                <use height="62.85" transform="matrix(1.0, 0.0, 0.0, 1.0, -14.2, -34.0)" width="43.35" xlinkHref="#lowerLeftArm-sprite97" />
              </g>
              <g id="lowerLeftArm-sprite97" transform="matrix(1.0, 0.0, 0.0, 1.0, 14.75, 35.55)">
                <use height="33.65" transform="matrix(0.8944, -0.0586, 0.0675, 1.0316, -14.7336, -16.4277)" width="30.4" xlinkHref="#sprite7-lower-left-arm" />
              </g>
              <g id="sprite7-lower-left-arm" transform="matrix(1.0, 0.0, 0.0, 1.0, 4.5, 6.05)">
                <use height="33.65" transform="matrix(1.0, 0.0, 0.0, 1.0, -4.5, -6.05)" width="30.4" xlinkHref="#shape1-lower-left-arm" />
              </g>
              <g id="shape1-lower-left-arm" transform="matrix(1.0, 0.0, 0.0, 1.0, 4.5, 6.05)">
        ...
        <>
          ...
          <defs>
            <g id="lowerLeftArm" transform="matrix(1.0, 0.0, 0.0, 1.0, 20.6, 29.0)">
              <use height="57.85" transform="matrix(1.0, 0.0, 0.0, 1.0, -20.6, -29.0)" width="42.4" xlinkHref="#lowerLeftArm-sprite94" />
            </g>
            <g id="lowerLeftArm-sprite94" transform="matrix(1.0, 0.0, 0.0, 1.0, 20.6, 29.0)">
              <use height="57.85" transform="matrix(1.0, 0.0, 0.0, 1.0, -20.6, -29.0)" width="42.4" xlinkHref="#lowerLeftArm-sprite95" />
            </g>
            <g id="lowerLeftArm-sprite95" transform="matrix(1.0, 0.0, 0.0, 1.0, 20.6, 29.0)">
              <use height="28.0" transform="matrix(0.9918, 0.1221, -0.1221, 0.9918, -4.6711, -14.6573)" width="12.0" xlinkHref="#lowerLeftArm-sprite96" />
              <use height="57.85" transform="matrix(1.0, 0.0, 0.0, 1.0, -20.6, -29.0)" width="42.4" xlinkHref="#lowerLeftArm-sprite97" />
            </g>
            <g id="lowerLeftArm-sprite96" transform="matrix(1.0, 0.0, 0.0, 1.0, 6.3, 1.45)">
              <use height="28.0" transform="matrix(1.0, 0.0, 0.0, 1.0, -6.3, -1.45)" width="12.0" xlinkHref="#lowerLeftArm-shape28" />
            </g>
            <g id="lowerLeftArm-shape28" transform="matrix(1.0, 0.0, 0.0, 1.0, 6.3, 1.45)">
            ...
            <g id="lowerLeftArm-sprite97" transform="matrix(1.0, 0.0, 0.0, 1.0, 21.15, 30.55)">
              <use height="33.65" transform="matrix(0.8944, -0.0586, 0.0396, 0.6048, -13.8145, -2.0958)" width="30.4" xlinkHref="#sprite7-lower-left-arm" />
            </g>
            <g id="sprite7-lower-left-arm" transform="matrix(1.0, 0.0, 0.0, 1.0, 4.5, 6.05)">
              <use height="33.65" transform="matrix(1.0, 0.0, 0.0, 1.0, -4.5, -6.05)" width="30.4" xlinkHref="#shape1-lower-left-arm" />
            </g>
