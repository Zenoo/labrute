...
const Pelvis = ({ gender, type }: PelvisProps) => {
  if (gender === 'male') {
    switch (type) {
      case 1:
        return (
          <>
            ...
            <defs>
              <g id="pelvis" transform="matrix(1.0, 0.0, 0.0, 1.0, 22.85, 18.1)">
                <use height="34.25" id="_p2" transform="matrix(1.0, 0.0, 0.0, 1.0, -22.85, -18.1)" width="46.3" xlinkHref="#sprite51" />
              </g>
              <g id="sprite51" transform="matrix(1.0, 0.0, 0.0, 1.0, 19.8, 24.05)">
                <use height="29.55" id="_p6" transform="matrix(1.0, 0.0, 0.0, 1.0, -12.8, -20.75)" width="30.8" xlinkHref="#sprite52" />
              </g>
              <g id="sprite52" transform="matrix(1.0, 0.0, 0.0, 1.0, 12.8, 20.75)">
                <use height="29.15" id="_col3" transform="matrix(1.0, 0.0, 0.0, 1.0, -12.55, -20.5)" width="30.4" xlinkHref="#sprite53" />
                <use height="29.55" id="_p7" transform="matrix(1.0, 0.0, 0.0, 1.0, -12.8, -20.75)" width="30.8" xlinkHref="#sprite54" />
              </g>
              <g id="sprite53" transform="matrix(1.0, 0.0, 0.0, 1.0, 15.2, 14.6)">
                <use height="29.15" transform="matrix(1.0, 0.0, 0.0, 1.0, -15.2, -14.6)" width="30.4" xlinkHref="#shape10" />
              </g>
        ...
        <>
          ...
          <defs>
            <g id="pelvis" transform="matrix(1.0, 0.0, 0.0, 1.0, 15.6, 14.55)">
              <use height="29.15" id="_p2" transform="matrix(1.0, 0.0, 0.0, 1.0, -15.6, -14.55)" width="30.4" xlinkHref="#sprite51" />
            </g>
            <g id="sprite51" transform="matrix(1.0, 0.0, 0.0, 1.0, 12.55, 20.5)">
              <use height="29.15" id="_p6" transform="matrix(1.0, 0.0, 0.0, 1.0, -12.55, -20.5)" width="30.4" xlinkHref="#sprite52" />
            </g>
            <g id="sprite52" transform="matrix(1.0, 0.0, 0.0, 1.0, 12.55, 20.5)">
              <use height="29.15" id="_col3" transform="matrix(1.0, 0.0, 0.0, 1.0, -12.55, -20.5)" width="30.4" xlinkHref="#sprite53" />
              <use height="29.15" id="_p7" transform="matrix(1.0, 0.0, 0.0, 1.0, -12.55, -20.5)" width="30.4" xlinkHref="#sprite54" />
            </g>
            <g id="sprite53" transform="matrix(1.0, 0.0, 0.0, 1.0, 15.2, 14.6)">
              <use height="29.15" transform="matrix(1.0, 0.0, 0.0, 1.0, -15.2, -14.6)" width="30.4" xlinkHref="#shape14" />
            </g>
