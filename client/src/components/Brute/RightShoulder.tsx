...
const RightShoulder = ({ gender, colors, type }: RightShoulderProps) => {
  if (gender === 'male') {
    switch (type) {
      case 1:
        return (
          <>
            ...
            <defs>
              <g id="rightShoulder" transform="matrix(1.0, 0.0, 0.0, 1.0, 30.15, 20.3)">
                <use height="44.75" transform="matrix(1.0, 0.0, 0.0, 1.0, -30.15, -20.3)" width="45.25" xlinkHref="#rightShoulder-sprite18" />
              </g>
              <g id="rightShoulder-sprite18" transform="matrix(1.0, 0.0, 0.0, 1.0, 30.15, 20.3)">
                <use height="37.75" transform="matrix(1.0, 0.0, 0.0, 1.0, -25.45, -17.2)" width="38.15" xlinkHref="#rightShoulder-sprite19" />
              </g>
              <g id="rightShoulder-sprite19" transform="matrix(1.0, 0.0, 0.0, 1.0, 25.45, 17.2)">
                <use height="37.75" transform="matrix(1.0, 0.0, 0.0, 1.0, -25.45, -17.2)" width="38.15" xlinkHref="#rightShoulder-sprite20" />
              </g>
              <g id="rightShoulder-sprite20" transform="matrix(1.0, 0.0, 0.0, 1.0, 25.45, 17.2)">
                <use height="14.1" transform="matrix(1.0, 0.0, 0.0, 1.0, -7.0, -7.05)" width="14.0" xlinkHref="#rightShoulder-sprite21" />
                <use height="22.3" transform="matrix(-0.7987, 0.5992, 0.5992, 0.7987, -0.6469, -17.1943)" width="24.6" xlinkHref="#rightShoulder-sprite22" />
              </g>
              <g id="rightShoulder-sprite21" transform="matrix(1.0, 0.0, 0.0, 1.0, 7.0, 7.05)">
                <use height="14.1" transform="matrix(1.0, 0.0, 0.0, 1.0, -7.0, -7.05)" width="14.0" xlinkHref="#rightShoulder-shape5" />
              </g>
              <g id="rightShoulder-shape5" transform="matrix(1.0, 0.0, 0.0, 1.0, 7.0, 7.05)">
        ...
        <>
          ...
          <defs>
            <g id="rightShoulder" transform="matrix(1.0, 0.0, 0.0, 1.0, 20.3, 17.2)">
              <use height="33.0" transform="matrix(1.0, 0.0, 0.0, 1.0, -20.3, -17.2)" width="33.0" xlinkHref="#rightShoulder-sprite18" />
            </g>
            <g id="rightShoulder-sprite18" transform="matrix(1.0, 0.0, 0.0, 1.0, 20.3, 17.2)">
              <use height="33.0" transform="matrix(1.0, 0.0, 0.0, 1.0, -20.3, -17.2)" width="33.0" xlinkHref="#rightShoulder-sprite19" />
            </g>
            <g id="rightShoulder-sprite19" transform="matrix(1.0, 0.0, 0.0, 1.0, 20.3, 17.2)">
              <use height="33.0" transform="matrix(1.0, 0.0, 0.0, 1.0, -20.3, -17.2)" width="33.0" xlinkHref="#rightShoulder-sprite20" />
            </g>
            <g id="rightShoulder-sprite20" transform="matrix(1.0, 0.0, 0.0, 1.0, 20.3, 17.2)">
              <use height="14.0" transform="matrix(1.0, 0.0, 0.0, 1.0, -6.95, -6.95)" width="13.8" xlinkHref="#rightShoulder-sprite21" />
              <use height="22.3" transform="matrix(-0.7987, 0.5992, 0.5992, 0.7987, -0.6469, -17.1943)" width="24.6" xlinkHref="#rightShoulder-sprite22" />
            </g>
            <g id="rightShoulder-sprite21" transform="matrix(1.0, 0.0, 0.0, 1.0, 6.95, 6.95)">
              <use height="14.0" transform="matrix(1.0, 0.0, 0.0, 1.0, -6.95, -6.95)" width="13.8" xlinkHref="#rightShoulder-shape8" />
            </g>
            <g id="rightShoulder-shape8" transform="matrix(1.0, 0.0, 0.0, 1.0, 6.95, 6.95)">
