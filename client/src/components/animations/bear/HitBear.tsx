...
const HitBear = ({ id, inverted }: HitBearProps) => (
  <Box sx={{
    position: 'relative',
    overflow: 'hidden',
    width: WIDTH,
  ...
  >
    ...
    <Box
      ...
      sx={{
        ...
        animation: `HitBear 1s steps(${FRAMES}, jump-none) infinite`,
        transform: inverted ? 'scale(-1, 1)' : null,
      }}
    >
      {/* FRAME 1 */}
      <g transform={`matrix(1.0, 0.0, 0.0, 1.0, ${X_OFFSET + (WIDTH + MARGIN) * 0}, ${Y_OFFSET})`}>
        <use height="39.8" transform="matrix(-0.5594, 0.9529, 0.9529, 0.5594, -18.0808, -56.4214)" width="21.6" xlinkHref={`#HitBear-1-${id}-sprite0`} />
        <use height="15.2" transform="matrix(0.5607, -0.741, 0.9018, 0.6825, 5.8052, 12.874)" width="34.85" xlinkHref={`#HitBear-1-${id}-sprite1`} />
        <use height="22.25" transform="matrix(0.689, 1.0078, 1.0078, -0.689, -15.9826, -1.0832)" width="15.4" xlinkHref={`#HitBear-1-${id}-sprite2`} />
        <use height="22.25" transform="matrix(-1.126, 0.7507, 0.4993, 0.7175, 14.6473, -10.556)" width="15.4" xlinkHref={`#HitBear-1-${id}-sprite2`} />
        <use height="30.1" transform="matrix(1.2208, -0.0583, 0.0583, 1.2208, -41.1663, -17.5543)" width="31.85" xlinkHref={`#HitBear-1-${id}-sprite3`} />
        <use height="44.65" transform="matrix(1.2208, -0.0583, 0.0583, 1.2208, -54.5939, -46.3403)" width="45.8" xlinkHref={`#HitBear-1-${id}-sprite4`} />
        <use height="22.25" transform="matrix(1.1646, 0.3646, -0.2783, 0.8889, -38.7576, 3.1255)" width="15.4" xlinkHref={`#HitBear-1-${id}-sprite2`} />
        <use height="22.25" transform="matrix(1.4752, 0.1242, -0.0866, 0.83, -44.2105, 19.1301)" width="15.4" xlinkHref={`#HitBear-1-${id}-sprite2`} />
        <use height="16.4" transform="matrix(0.9993, -0.0355, 0.0355, 0.9993, -47.0798, 31.781)" width="26.75" xlinkHref={`#HitBear-1-${id}-sprite5`} />
        <use height="17.8" transform="matrix(-0.7838, 0.445, 0.445, 0.7838, 15.8562, -37.1559)" width="16.75" xlinkHref={`#HitBear-1-${id}-sprite6`} />
        <use height="39.8" transform="matrix(0.9719, 0.7374, -0.7374, 0.9719, -50.3513, -47.2167)" width="21.6" xlinkHref={`#HitBear-1-${id}-sprite0`} />
        <use height="17.8" transform="matrix(0.9682, 0.2471, -0.2471, 0.9682, -77.0085, -13.5478)" width="16.75" xlinkHref={`#HitBear-1-${id}-sprite6`} />
        <use height="24.2" transform="matrix(-1.1954, 0.2542, 0.2542, 1.1954, -18.1091, -52.0766)" width="23.7" xlinkHref={`#HitBear-1-${id}-sprite7`} />
      </g>
      <defs>
        <g id={`HitBear-1-${id}-sprite0`} transform="matrix(1.0, 0.0, 0.0, 1.0, 9.8, 19.9)">
          <use height="39.8" transform="matrix(1.0, 0.0, 0.0, 1.0, -9.8, -19.9)" width="21.6" xlinkHref={`#HitBear-1-${id}-shape0`} />
        </g>
        <g id={`HitBear-1-${id}-shape0`} transform="matrix(1.0, 0.0, 0.0, 1.0, 9.8, 19.9)">
          <path d="M-1.6 4.0 L-1.55 4.1 -1.75 4.25 -1.6 4.0" fill="#996600" fillRule="evenodd" stroke="none" />
          <path d="M-5.8 17.85 L-6.3 17.35 Q-8.4 14.9 -8.4 11.75 L-8.3 11.4 -8.2 10.6 -8.2 10.3 -8.15 9.15 -8.1 4.85 -9.8 0.7 Q-5.85 -4.75 -8.15 -3.25 L-9.55 -1.65 Q-9.05 -2.75 -5.15 -8.25 L-1.1 -13.9 Q2.4 -17.7 4.6 -19.2 5.1 -19.5 5.6 -19.9 7.15 -18.95 8.25 -17.35 L8.8 -16.5 Q6.95 -15.1 3.6 -11.55 L-1.9 -5.3 3.15 -8.1 Q0.35 -5.9 -1.5 -1.05 L-3.75 6.1 -3.65 6.15 -1.75 4.25 -2.35 5.4 -2.95 7.2 -3.2 8.15 -2.85 11.2 -2.65 12.15 -2.85 13.85 -2.6 15.3 -2.6 15.6 -4.05 14.8 -5.65 13.95 Q-6.15 14.75 -6.15 16.7 L-5.8 17.85" fill="#764701" fillRule="evenodd" stroke="none" />
          <path d="M-5.8 17.85 L-6.15 16.7 Q-6.15 14.75 -5.65 13.95 L-4.05 14.8 -2.6 15.6 -2.6 15.3 -2.85 13.85 -2.65 12.15 -2.85 11.2 -3.2 8.15 -2.95 7.2 -2.35 5.4 -1.75 4.25 -3.65 6.15 -3.75 6.1 -1.5 -1.05 Q0.35 -5.9 3.15 -8.1 L-1.9 -5.3 3.6 -11.55 Q6.95 -15.1 8.8 -16.5 L10.25 -13.55 11.25 -9.9 11.8 -6.55 11.8 -6.45 10.85 -5.0 Q6.45 2.3 5.1 9.9 4.75 11.9 4.65 13.95 L4.65 14.1 Q4.4 17.6 3.8 18.5 2.85 19.9 -0.65 19.9 -3.35 19.9 -5.3 18.3 L-5.8 17.85 M-1.6 4.0 L-1.75 4.25 -1.55 4.1 -1.6 4.0" fill="#4a2001" fillRule="evenodd" stroke="none" />
          <path d="M5.6 -19.9 Q5.1 -19.5 4.6 -19.2 2.4 -17.7 -1.1 -13.9 L-5.15 -8.25 Q-9.05 -2.75 -9.55 -1.65 L-8.15 -3.25 Q-5.85 -4.75 -9.8 0.7 L-8.1 4.85 -8.15 9.15 -8.2 10.3 -8.2 10.6 -8.3 11.4 -8.4 11.75 Q-8.4 14.9 -6.3 17.35 L-5.8 17.85 M-5.3 18.3 Q-3.35 19.9 -0.65 19.9 2.85 19.9 3.8 18.5 4.4 17.6 4.65 14.1 L4.65 13.95 Q4.75 11.9 5.1 9.9 6.45 2.3 10.85 -5.0 L11.8 -6.45" fill="none" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.8" strokeWidth="0.05" />
        </g>
        <g id={`HitBear-1-${id}-sprite1`} transform="matrix(1.0, 0.0, 0.0, 1.0, 15.85, 6.55)">
          <use height="15.2" transform="matrix(1.0, 0.0, 0.0, 1.0, -15.85, -6.55)" width="34.85" xlinkHref={`#HitBear-1-${id}-shape1`} />
        </g>
        <g id={`HitBear-1-${id}-shape1`} transform="matrix(1.0, 0.0, 0.0, 1.0, 15.85, 6.55)">
          <path d="M17.8 2.8 L14.25 2.15 14.75 1.7 Q15.3 1.8 15.6 1.35 15.35 0.95 15.45 0.85 L15.75 0.6 Q16.55 0.8 17.3 1.45 L18.2 2.45 Q18.4 2.85 17.8 2.8" fill="#000000" fillRule="evenodd" stroke="none" />
