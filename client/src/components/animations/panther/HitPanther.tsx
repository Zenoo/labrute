...
export interface HitPantherProps extends BoxProps {
  id: string;
  inverted?: boolean;
}
  ...
  >
    ...
    <Box
      ...
      sx={{
        ...
        animation: 'StaggerPanther 0.5s forwards',
        transform: !inverted ? 'scale(-1, 1)' : null,
      }}
    >
      {/* FRAME 1 */}
      <g transform={`matrix(1.5, 0.0, 0.0, 1.5, ${X_OFFSET + (WIDTH + MARGIN) * 0}, ${Y_OFFSET})`}>
        <use height="3.75" transform="matrix(1.2716, 0.0, 0.0, 1.1527, -16.1513, 7.3175)" width="5.9" xlinkHref={`#HitPanther-1-${id}-sprite0`} />
        <use height="5.75" transform="matrix(1.7642, 0.9536, -1.052, 1.5992, -6.2623, -1.5898)" width="1.75" xlinkHref={`#HitPanther-1-${id}-sprite1`} />
        <use height="5.75" transform="matrix(2.045, -1.2738, 1.0218, 1.3478, -11.8163, -4.4642)" width="1.75" xlinkHref={`#HitPanther-1-${id}-sprite1`} />
        <use height="3.75" transform="matrix(1.1367, 0.0, 0.0, 0.9855, -3.6033, 4.3768)" width="5.9" xlinkHref={`#HitPanther-1-${id}-sprite0`} />
        <use height="7.55" transform="matrix(1.4676, -0.0501, 0.0578, 1.2724, 1.8427, -8.9012)" width="4.85" xlinkHref={`#HitPanther-1-${id}-sprite2`} />
        <use height="5.75" transform="matrix(1.7667, 0.4337, -0.5002, 1.5317, 3.1172, -3.3542)" width="1.75" xlinkHref={`#HitPanther-1-${id}-sprite1`} />
        <use height="3.75" transform="matrix(0.8564, 0.1323, -0.1735, 1.1228, 5.7446, 7.8324)" width="5.9" xlinkHref={`#HitPanther-1-${id}-sprite0`} />
        <use height="3.75" transform="matrix(1.389, 0.0, 0.0, 1.389, -11.2976, 13.0803)" width="5.9" xlinkHref={`#HitPanther-1-${id}-sprite0`} />
        <use height="5.4" transform="matrix(0.6441, 0.9337, -0.9337, 0.6441, 11.7762, -10.4814)" width="13.85" xlinkHref={`#HitPanther-1-${id}-sprite3`} />
        <use height="7.2" transform="matrix(-1.3715, 0.1448, 0.1448, 1.3715, 12.912, -12.1147)" width="8.9" xlinkHref={`#HitPanther-1-${id}-sprite4`} />
        <use height="7.2" transform="matrix(2.0253, 0.0, 0.0, 2.4905, -10.315, -12.5403)" width="8.9" xlinkHref={`#HitPanther-1-${id}-sprite4`} />
        <use height="13.0" transform="matrix(1.3595, -0.1926, 0.1926, 1.3595, -20.2217, -10.3495)" width="16.45" xlinkHref={`#HitPanther-1-${id}-sprite5`} />
        <use height="5.75" transform="matrix(1.8096, 0.3058, -0.3058, 1.8096, 9.279, -1.1585)" width="1.75" xlinkHref={`#HitPanther-1-${id}-sprite1`} />
        <use height="7.55" transform="matrix(1.3465, -0.5847, 0.5847, 1.3465, 3.4973, -5.1555)" width="4.85" xlinkHref={`#HitPanther-1-${id}-sprite2`} />
        <use height="5.75" transform="matrix(2.0815, 0.8353, -0.8353, 2.0815, -2.8049, 2.3317)" width="1.75" xlinkHref={`#HitPanther-1-${id}-sprite1`} />
        <use height="5.75" transform="matrix(2.706, -0.0317, 0.023, 1.9676, -3.5959, -5.8713)" width="1.75" xlinkHref={`#HitPanther-1-${id}-sprite1`} />
      </g>
      <defs>
        <g id={`HitPanther-1-${id}-sprite0`} transform="matrix(1.0, 0.0, 0.0, 1.0, 2.95, 1.85)">
          <use height="3.75" transform="matrix(1.0, 0.0, 0.0, 1.0, -2.95, -1.85)" width="5.9" xlinkHref={`#HitPanther-1-${id}-shape0`} />
        </g>
        <g id={`HitPanther-1-${id}-shape0`} transform="matrix(1.0, 0.0, 0.0, 1.0, 2.95, 1.85)">
        ...
        <g id={`HitPanther-1-${id}-sprite1`} transform="matrix(1.0, 0.0, 0.0, 1.0, 1.25, 2.75)">
          <use height="5.75" transform="matrix(1.0, 0.0, 0.0, 1.0, -1.25, -2.75)" width="1.75" xlinkHref={`#HitPanther-1-${id}-shape1`} />
        </g>
        <g id={`HitPanther-1-${id}-shape1`} transform="matrix(1.0, 0.0, 0.0, 1.0, 1.25, 2.75)">
        ...
        <g id={`HitPanther-1-${id}-sprite2`} transform="matrix(1.0, 0.0, 0.0, 1.0, 2.4, 3.2)">
          <use height="7.55" transform="matrix(1.0, 0.0, 0.0, 1.0, -2.4, -3.2)" width="4.85" xlinkHref={`#HitPanther-1-${id}-shape2`} />
        </g>
        <g id={`HitPanther-1-${id}-shape2`} transform="matrix(1.0, 0.0, 0.0, 1.0, 2.4, 3.2)">
        ...
        <g id={`HitPanther-1-${id}-sprite3`} transform="matrix(1.0, 0.0, 0.0, 1.0, 6.9, 2.7)">
          <use height="5.4" transform="matrix(1.0, 0.0, 0.0, 1.0, -6.9, -2.7)" width="13.85" xlinkHref={`#HitPanther-1-${id}-shape3`} />
        </g>
        <g id={`HitPanther-1-${id}-shape3`} transform="matrix(1.0, 0.0, 0.0, 1.0, 6.9, 2.7)">
        ...
        <g id={`HitPanther-1-${id}-sprite4`} transform="matrix(1.0, 0.0, 0.0, 1.0, 4.55, 3.65)">
          <use height="7.2" transform="matrix(1.0, 0.0, 0.0, 1.0, -4.55, -3.65)" width="8.9" xlinkHref={`#HitPanther-1-${id}-shape4`} />
        </g>
        <g id={`HitPanther-1-${id}-shape4`} transform="matrix(1.0, 0.0, 0.0, 1.0, 4.55, 3.65)">
        ...
        <g id={`HitPanther-1-${id}-sprite5`} transform="matrix(1.0, 0.0, 0.0, 1.0, 7.65, 6.6)">
          <use height="13.0" transform="matrix(1.0, 0.0, 0.0, 1.0, -7.65, -6.6)" width="16.45" xlinkHref={`#HitPanther-1-${id}-shape5`} />
        </g>
        <g id={`HitPanther-1-${id}-shape5`} transform="matrix(1.0, 0.0, 0.0, 1.0, 7.65, 6.6)">
