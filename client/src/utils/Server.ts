...
const Server = {
  ...
  Brute: {
    ...
    getNeighborsForRank: ({ name, rank }: { name: string, rank?: number }) => Fetch<BrutesGetNeighborsForRankResponse>(`/api/brute/${name}/neighbors${typeof rank === 'undefined' ? '' : `/${rank}`}`),
