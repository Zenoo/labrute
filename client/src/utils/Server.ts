import {
  ...
  ConfigsSetResponse, EditSharedBrowserRequest, EventGetResponse,
  EventGetRoundResponse, EventListCurrentResponse,
  EventListResponse, FightCreateResponse, FightGetResponse, GetFingerprintResponse,
  GetSharedBrowserResponse, KnownFingerprintAddRequest,
  KnownFingerprintListResponse, KnownFingerprintRemoveRequest,
...
export const Server = {
  ...
  OAuth: {
    token: (body: OAuthTokenRequest) => Fetch<UsersAuthenticateResponse>('/api/oauth/token', body, 'POST'),
  },
  User: {
  ...
  Brute: {
    ...
    reset: (name: string) => Fetch<ServerHookBrute>(`/api/brute/${name}/reset`, {}, 'PATCH'),
    resetVisuals: (name: string, body: string, colors: string) => Fetch<never>(`/api/brute/${name}/reset-visuals`, { body, colors }, 'PATCH'),
    unlockColor: (name: string, params: BruteUnlockColorRequest) => Fetch<BruteUnlockColorResponse>(`/api/brute/${name}/unlock-color`, params, 'PATCH'),
