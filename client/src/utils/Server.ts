...
const Server = {
  ...
  Config: {
    ...
    set: (key: string, value: string) => Fetch<ConfigsSetResponse>('/api/config/set', { key, value } as ConfigsSetRequest, 'POST'),
