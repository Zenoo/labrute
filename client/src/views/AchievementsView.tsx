                        ...
                        <AchievementTooltip achievement={achievement}>
                          ...
                          >
                            <Box
                              ...
                              sx={{ width: 20 }}
                            />
                            <Text smallCaps bold color="secondary.contrastText" sx={{ ml: 1 }}>{t(achievement.name)}</Text>
                          </ListSubheader>
                        </AchievementTooltip>
                      )}
                    >
                      {availableTitles.map((titleCount, i) => {
                        ...
                        return (
                          <Tooltip key={`${achievement.name}x${titleCount}`} title={`${t(achievement.name)} x ${titleCount}`}>
                            <ListItem sx={{
                              py: 0,
                              '&:not(:last-child)': {
