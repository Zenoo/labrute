...
const ClanView = () => {
  ...
  const canManageRoles = useMemo(() => {
    ...
    return bruteMember?.clanRoles.some((r) => r.role.permissions.includes(ClanPermission.canCreateRoles)
      || r.role.permissions.includes(ClanPermission.canChangeRoles)) ?? false;
  }, [clan, brute]);
