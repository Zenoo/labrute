...
// @ts-nocheck 
/*
 * This file exports the `ClanPost` model and its related types.
 *
...
export type GetClanPostAggregateType<T extends ClanPostAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateClanPost[P]>
    : Prisma.GetScalarType<T[P], AggregateClanPost[P]>
}
...
export type GetClanPostGroupByPayload<T extends ClanPostGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ClanPostGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ClanPostGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ClanPostGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ClanPostGroupByOutputType[P]>
      }
    >
  >
...
export type ClanPostCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface ClanPostDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends ClanPostCountArgs>(
    args?: Prisma.Subset<T, ClanPostCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ClanPostCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, ClanPostGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetClanPostGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
