...
// @ts-nocheck 
/*
 * This file exports the `KnownFingerprint` model and its related types.
 *
...
export type GetKnownFingerprintAggregateType<T extends KnownFingerprintAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateKnownFingerprint[P]>
    : Prisma.GetScalarType<T[P], AggregateKnownFingerprint[P]>
}
...
export type GetKnownFingerprintGroupByPayload<T extends KnownFingerprintGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<KnownFingerprintGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof KnownFingerprintGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], KnownFingerprintGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], KnownFingerprintGroupByOutputType[P]>
      }
    >
  >
...
export type KnownFingerprintCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface KnownFingerprintDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends KnownFingerprintCountArgs>(
    args?: Prisma.Subset<T, KnownFingerprintCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], KnownFingerprintCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, KnownFingerprintGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetKnownFingerprintGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
