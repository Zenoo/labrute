...
// @ts-nocheck 
/*
 * This file exports the `TournamentXp` model and its related types.
 *
...
export type GetTournamentXpAggregateType<T extends TournamentXpAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTournamentXp[P]>
    : Prisma.GetScalarType<T[P], AggregateTournamentXp[P]>
}
...
export type GetTournamentXpGroupByPayload<T extends TournamentXpGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<TournamentXpGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof TournamentXpGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], TournamentXpGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], TournamentXpGroupByOutputType[P]>
      }
    >
  >
...
export type TournamentXpCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface TournamentXpDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends TournamentXpCountArgs>(
    args?: Prisma.Subset<T, TournamentXpCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], TournamentXpCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, TournamentXpGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTournamentXpGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
