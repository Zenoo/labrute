...
// @ts-nocheck 
/*
 * This file exports the `BruteReport` model and its related types.
 *
...
export type GetBruteReportAggregateType<T extends BruteReportAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateBruteReport[P]>
    : Prisma.GetScalarType<T[P], AggregateBruteReport[P]>
}
...
export type GetBruteReportGroupByPayload<T extends BruteReportGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<BruteReportGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof BruteReportGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], BruteReportGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], BruteReportGroupByOutputType[P]>
      }
    >
  >
...
export type BruteReportCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface BruteReportDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends BruteReportCountArgs>(
    args?: Prisma.Subset<T, BruteReportCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], BruteReportCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, BruteReportGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBruteReportGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
