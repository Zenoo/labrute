...
// @ts-nocheck 
/*
 * This file exports the `ClanWarFighters` model and its related types.
 *
...
export type GetClanWarFightersAggregateType<T extends ClanWarFightersAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateClanWarFighters[P]>
    : Prisma.GetScalarType<T[P], AggregateClanWarFighters[P]>
}
...
export type GetClanWarFightersGroupByPayload<T extends ClanWarFightersGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ClanWarFightersGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ClanWarFightersGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ClanWarFightersGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ClanWarFightersGroupByOutputType[P]>
      }
    >
  >
...
export type ClanWarFightersCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface ClanWarFightersDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends ClanWarFightersCountArgs>(
    args?: Prisma.Subset<T, ClanWarFightersCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ClanWarFightersCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, ClanWarFightersGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetClanWarFightersGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
