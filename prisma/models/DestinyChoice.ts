...
// @ts-nocheck 
/*
 * This file exports the `DestinyChoice` model and its related types.
 *
...
export type GetDestinyChoiceAggregateType<T extends DestinyChoiceAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateDestinyChoice[P]>
    : Prisma.GetScalarType<T[P], AggregateDestinyChoice[P]>
}
...
export type GetDestinyChoiceGroupByPayload<T extends DestinyChoiceGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<DestinyChoiceGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof DestinyChoiceGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], DestinyChoiceGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], DestinyChoiceGroupByOutputType[P]>
      }
    >
  >
...
export type DestinyChoiceCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface DestinyChoiceDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends DestinyChoiceCountArgs>(
    args?: Prisma.Subset<T, DestinyChoiceCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], DestinyChoiceCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, DestinyChoiceGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDestinyChoiceGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
