...
// @ts-nocheck 
/*
 * This file exports the `BruteStartingStats` model and its related types.
 *
...
export type GetBruteStartingStatsAggregateType<T extends BruteStartingStatsAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateBruteStartingStats[P]>
    : Prisma.GetScalarType<T[P], AggregateBruteStartingStats[P]>
}
...
export type GetBruteStartingStatsGroupByPayload<T extends BruteStartingStatsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<BruteStartingStatsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof BruteStartingStatsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], BruteStartingStatsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], BruteStartingStatsGroupByOutputType[P]>
      }
    >
  >
...
export type BruteStartingStatsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface BruteStartingStatsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends BruteStartingStatsCountArgs>(
    args?: Prisma.Subset<T, BruteStartingStatsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], BruteStartingStatsCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, BruteStartingStatsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBruteStartingStatsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
