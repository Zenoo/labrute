...
// @ts-nocheck 
/*
 * This file exports the `TournamentGold` model and its related types.
 *
...
export type GetTournamentGoldAggregateType<T extends TournamentGoldAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTournamentGold[P]>
    : Prisma.GetScalarType<T[P], AggregateTournamentGold[P]>
}
...
export type GetTournamentGoldGroupByPayload<T extends TournamentGoldGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<TournamentGoldGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof TournamentGoldGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], TournamentGoldGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], TournamentGoldGroupByOutputType[P]>
      }
    >
  >
...
export type TournamentGoldCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface TournamentGoldDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends TournamentGoldCountArgs>(
    args?: Prisma.Subset<T, TournamentGoldCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], TournamentGoldCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, TournamentGoldGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTournamentGoldGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
